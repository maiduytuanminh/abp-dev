...
try
{
    ...
    switch (option)
    {
        ...
        case _1.Options.Find:
        {
            ...
            var defaultCulture = new SmartSoftwareLocalization(path, defaultLocalizationInfo!);
            ...
            if (options.Contains(_4.Options.ArgumentsCount))
            {
                ...
                if (options2.Contains(_5.Options.Export))
                {
                    if (options.Contains(_4.Options.MissingKeys))
                    {
                        ...
                        LocalizationHelper.Export<SmartSoftwareAsyncKey>(asyncLocalizations, exportPath);
                    }
                    else
                    {
