...
namespace SmartSoftware.AspNetCore.Components.Web.Theming.Components.LayoutHooks;
...
public partial class LayoutHook : ComponentBase
{
    ...
    [Inject]
    protected IOptions<SmartSoftwareLayoutHookOptions> LayoutHookOptions { get; set; } = default!;
