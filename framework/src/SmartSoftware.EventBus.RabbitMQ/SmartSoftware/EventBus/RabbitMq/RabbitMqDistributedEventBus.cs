...
{
    protected SmartSoftwareRabbitMqEventBusOptions SmartSoftwareRabbitMqEventBusOptions { get; }
    ...
    public RabbitMqDistributedEventBus(
        IOptions<SmartSoftwareRabbitMqEventBusOptions> options,
            ...
            correlationIdProvider)
    {
        ...
        SmartSoftwareRabbitMqEventBusOptions = options.Value;
    ...
    public void Initialize()
    {
        Consumer = MessageConsumerFactory.Create(
            new ExchangeDeclareConfiguration(
                SmartSoftwareRabbitMqEventBusOptions.ExchangeName,
                type: SmartSoftwareRabbitMqEventBusOptions.GetExchangeTypeOrDefault(),
                durable: true,
                arguments: SmartSoftwareRabbitMqEventBusOptions.ExchangeArguments
            ),
            new QueueDeclareConfiguration(
                SmartSoftwareRabbitMqEventBusOptions.ClientName,
                durable: true,
                exclusive: false,
                autoDelete: false,
                prefetchCount: SmartSoftwareRabbitMqEventBusOptions.PrefetchCount,
                arguments: SmartSoftwareRabbitMqEventBusOptions.QueueArguments
            ),
            SmartSoftwareRabbitMqEventBusOptions.ConnectionName
        );
    ...
    public async override Task PublishManyFromOutboxAsync(
        ...
        OutboxConfig outboxConfig)
    {
        using (var channel = ConnectionPool.Get(SmartSoftwareRabbitMqEventBusOptions.ConnectionName).CreateModel())
        {
        ...
        string? correlationId = null)
    {
        ...
        channel.BasicPublish(
            exchange: SmartSoftwareRabbitMqEventBusOptions.ExchangeName,
    ...
    private void EnsureExchangeExists(IModel channel)
    {
        ...
        try
        {
            using (var temporaryChannel = ConnectionPool.Get(SmartSoftwareRabbitMqEventBusOptions.ConnectionName).CreateModel())
            {
                temporaryChannel.ExchangeDeclarePassive(SmartSoftwareRabbitMqEventBusOptions.ExchangeName);
            }
        }
        catch (Exception)
        {
            channel.ExchangeDeclare(
                SmartSoftwareRabbitMqEventBusOptions.ExchangeName,
                SmartSoftwareRabbitMqEventBusOptions.GetExchangeTypeOrDefault(),
                durable: true
            );
        }
