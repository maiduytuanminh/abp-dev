...
public class ApplicationLocalizationConfigurationDto
{
    ...
    /// (by SmartSoftwareApplicationConfigurationAppService). However, it is here to be filled
    /// using the application localization endpoint (SmartSoftwareApplicationLocalizationAppService).
