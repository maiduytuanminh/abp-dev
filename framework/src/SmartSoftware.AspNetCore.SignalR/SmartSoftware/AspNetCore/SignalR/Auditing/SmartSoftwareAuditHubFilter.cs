...
public class SmartSoftwareAuditHubFilter : IHubFilter
{
    ...
    {
        var options = invocationContext.ServiceProvider.GetRequiredService<IOptions<SmartSoftwareAuditingOptions>>().Value;
    ...
    {
        var options = serviceProvider.GetRequiredService<IOptions<SmartSoftwareAuditingOptions>>().Value;
