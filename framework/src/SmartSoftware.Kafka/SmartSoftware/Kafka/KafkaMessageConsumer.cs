...
public class KafkaMessageConsumer : IKafkaMessageConsumer, ITransientDependency, IDisposable
{
    ...
    protected SmartSoftwareKafkaOptions Options { get; }
    ...
    public KafkaMessageConsumer(
        ...
        IOptions<SmartSoftwareKafkaOptions> options,
    ...
    protected virtual async Task Timer_Elapsed(SmartSoftwareAsyncTimer timer)
    {
        if (Consumer == null)
        {
