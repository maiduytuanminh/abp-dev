...
public class SmartSoftwareAsyncIntegratedTest<TStartupModule> : SmartSoftwareTestBaseWithServiceProvider
    where TStartupModule : ISmartSoftwareModule
{
    protected ISmartSoftwareApplication Application { get; set; } = default!;
    ...
    public virtual async Task InitializeAsync()
    {
        ...
        var application = await services.AddApplicationAsync<TStartupModule>(await SetSmartSoftwareApplicationCreationOptionsAsync());
    ...
    protected virtual Task<Action<SmartSoftwareApplicationCreationOptions>> SetSmartSoftwareApplicationCreationOptionsAsync()
    {
        return Task.FromResult<Action<SmartSoftwareApplicationCreationOptions>>(_ => { });
    }
