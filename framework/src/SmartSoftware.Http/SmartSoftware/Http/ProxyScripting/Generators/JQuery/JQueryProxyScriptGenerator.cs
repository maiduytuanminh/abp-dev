...
//TODO: Add ss.ajax, ss.utils... etc.

public class JQueryProxyScriptGenerator : IProxyScriptGenerator, ITransientDependency
{
    //TODO: Should move this to Ddd package by adding an option to SmartSoftwareHttpAbstractions module. Also duplicated of ApplicationService.CommonPostfixes
    ...
    public string CreateScript(ApplicationApiDescriptionModel model)
    {
        ...
        script.AppendLine("/* This file is automatically generated by SS framework to use MVC Controllers from javascript. */");
        script.AppendLine();
    ...
    private static void AddControllerScript(StringBuilder script, ControllerApiDescriptionModel controller)
    {
        ...
        script.AppendLine($"    ss.utils.createNamespace(window, '{controllerName}');");
    ...
    private static void AddActionScript(StringBuilder script, string controllerName, ActionApiDescriptionModel action, string normalizedActionName)
    {
        ...
        script.AppendLine("      return ss.ajax($.extend(true, {");
    ...
    private static void AddAjaxCallParameters(StringBuilder script, ActionApiDescriptionModel action)
    {
        ...
        script.AppendLine("        url: ss.appPath + '" + ProxyScriptingHelper.GenerateUrlWithParameters(action) + "',");
    ...
    {
        script.AppendLine();
        script.AppendLine("ss.event.trigger('ss.serviceProxyScriptInitialized');");
    }
