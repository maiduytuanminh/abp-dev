...
public class LocalizationResourceDictionary : Dictionary<string, LocalizationResourceBase>
{
    ...
    public LocalizationResource Add(Type resourceType, string? defaultCultureName = null)
    {
        ...
        {
            throw new SmartSoftwareException("This resource is already added before: " + resourceType.AssemblyQualifiedName);
        }
    ...
    public NonTypedLocalizationResource Add([NotNull] string resourceName, string? defaultCultureName = null)
    {
        ...
        if (ContainsKey(resourceName))
        {
            throw new SmartSoftwareException("This resource is already added before: " + resourceName);
        }
    ...
    public LocalizationResourceBase Get<TResource>()
    {
        ...
        if (resource == null)
        {
            throw new SmartSoftwareException("Can not find a resource with given type: " + resourceType.AssemblyQualifiedName);
        }
    ...
    public LocalizationResourceBase Get(string resourceName)
    {
        ...
        if (resource == null)
        {
            throw new SmartSoftwareException("Can not find a resource with given name: " + resourceName);
        }
    ...
    public LocalizationResourceBase Get(Type resourceType)
    {
        ...
        if (resource == null)
        {
            throw new SmartSoftwareException("Can not find a resource with given type: " + resourceType);
        }
