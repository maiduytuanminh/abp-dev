...
namespace SmartSoftware.Localization.Json;
...
public static class JsonLocalizationDictionaryBuilder
{
    ...
    public static ILocalizationDictionary? BuildFromFile(string filePath)
    {
        ...
        {
            throw new SmartSoftwareException("Invalid localization file format: " + filePath, ex);
        }
    }
    ...
    public static ILocalizationDictionary? BuildFromJsonString(string jsonString)
    {
        ...
        {
            throw new SmartSoftwareException("Can not parse json string. " + ex.Message);
        }
        ...
        foreach (var item in jsonFile.Texts)
        {
            ...
            {
                throw new SmartSoftwareException("The key is empty in given json string.");
            }
