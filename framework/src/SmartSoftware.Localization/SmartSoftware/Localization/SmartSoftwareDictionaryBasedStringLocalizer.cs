...
public class SmartSoftwareDictionaryBasedStringLocalizer : ISmartSoftwareStringLocalizer
{
    public LocalizationResourceBase Resource { get; }

    public List<IStringLocalizer> BaseLocalizers { get; }

    public SmartSoftwareLocalizationOptions SmartSoftwareLocalizationOptions { get; }
    ...
    public SmartSoftwareDictionaryBasedStringLocalizer(
        LocalizationResourceBase resource,
        List<IStringLocalizer> baseLocalizers,
        SmartSoftwareLocalizationOptions ssLocalizationOptions)
    {
        Resource = resource;
        ...
        bool tryDefaults = true)
    {
        ...
        if (SmartSoftwareLocalizationOptions.TryToGetFromBaseCulture)
        {
        ...
        if (SmartSoftwareLocalizationOptions.TryToGetFromDefaultCulture)
        {
    ...
    public class CultureWrapperStringLocalizer : ISmartSoftwareStringLocalizer
    {
        private readonly string _cultureName;
        private readonly SmartSoftwareDictionaryBasedStringLocalizer _innerLocalizer;
        ...
        public CultureWrapperStringLocalizer(string cultureName, SmartSoftwareDictionaryBasedStringLocalizer innerLocalizer)
        {
