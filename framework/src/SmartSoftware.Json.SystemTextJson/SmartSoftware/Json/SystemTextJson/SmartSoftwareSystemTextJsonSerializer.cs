...
public class SmartSoftwareSystemTextJsonSerializer : IJsonSerializer, ITransientDependency
{
    protected SmartSoftwareSystemTextJsonSerializerOptions Options { get; }

    public SmartSoftwareSystemTextJsonSerializer(IOptions<SmartSoftwareSystemTextJsonSerializerOptions> options)
    {
