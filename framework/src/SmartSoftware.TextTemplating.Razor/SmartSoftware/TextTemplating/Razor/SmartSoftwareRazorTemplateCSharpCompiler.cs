...
public class SmartSoftwareRazorTemplateCSharpCompiler : ISingletonDependency
{
    protected SmartSoftwareRazorTemplateCSharpCompilerOptions Options { get; }

    public SmartSoftwareRazorTemplateCSharpCompiler(IOptions<SmartSoftwareRazorTemplateCSharpCompilerOptions> options)
    {
    ...
    private static IEnumerable<PortableExecutableReference> DefaultReferences => new List<Assembly>()
            {
                ...
                typeof(SmartSoftwareRazorTemplateCSharpCompiler).Assembly
            }
