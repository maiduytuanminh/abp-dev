...
public class RazorTemplateRenderingEngine : TemplateRenderingEngineBase, ITransientDependency
{
        ...
        object? model = null)
    {
        ...
        {
            var compiledViewProvider = scope.ServiceProvider.GetRequiredService<ISmartSoftwareCompiledViewProvider>();
            var assembly = await compiledViewProvider.GetAssemblyAsync(templateDefinition);
            var templateType = assembly.GetType(SmartSoftwareRazorTemplateConsts.TypeName)!;
