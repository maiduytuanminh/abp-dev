...
namespace SmartSoftware.AspNetCore.Mvc.UI.Theme.Shared.Demo.Views.Components.Themes.Shared.TagHelpers;

public class SmartSoftwareComponentDemoSectionTagHelper : SmartSoftwareTagHelper
{
    private const string DemoSectionOpeningTag = "<ss-component-demo-section";
    private const string DemoSectionClosingTag = "</ss-component-demo-section";
    ...
    public SmartSoftwareComponentDemoSectionTagHelper(
    ...
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        output.PostContent.AppendHtml($"<a class=\"nav-link active\" id=\"tag-helper-tab-{tagHelperCodeBlockId}\" data-bs-toggle=\"pill\" href=\"#tag-helper-{tagHelperCodeBlockId}\" role=\"tab\" aria-controls=\"tag-helper-{tagHelperCodeBlockId}\" aria-selected=\"true\">SmartSoftware Tag Helper</a>");
    ...
    private string GetRawDemoSource()
    {
        ...
        throw new SmartSoftwareException($"Could not find {Title} demo section inside {ViewPath}");
    }
