...
public class SmartSoftwareBorderTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareBorderTagHelper>
{
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        var borderAttributeAsString = TagHelper.SmartSoftwareBorder.ToString().ToLowerInvariant();
