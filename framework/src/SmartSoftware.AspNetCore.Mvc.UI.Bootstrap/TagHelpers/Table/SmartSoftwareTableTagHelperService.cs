...
public class SmartSoftwareTableTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareTableTagHelper>
{
    ...
    protected virtual void SetBorderStyle(TagHelperContext context, TagHelperOutput output)
    {
        ...
        {
            case SmartSoftwareTableBorderStyle.Default:
                return;
            case SmartSoftwareTableBorderStyle.Bordered:
                output.Attributes.AddClass("table-bordered");
                return;
            case SmartSoftwareTableBorderStyle.Borderless:
