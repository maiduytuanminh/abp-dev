...
public class SmartSoftwareTabDropdownTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareTabDropdownTagHelper>
{
    ...
    protected virtual string GetTabHeaderItem(TagHelperContext context, TagHelperOutput output)
    {
        ...
        menu.InnerHtml.Append(SmartSoftwareTabDropdownItemsActivePlaceholder);
