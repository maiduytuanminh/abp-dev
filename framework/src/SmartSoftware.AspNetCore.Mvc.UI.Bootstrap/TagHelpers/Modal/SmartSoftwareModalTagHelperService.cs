...
public class SmartSoftwareModalTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareModalTagHelper>
{
    ...
    protected virtual string GetModalDialogClasses()
    {
        ...
        if (TagHelper.Size != SmartSoftwareModalSize.Default)
        {
            classNames.Append(" ");
