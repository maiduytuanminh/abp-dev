...
public class SmartSoftwareProgressBarTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareProgressBarTagHelper>
{
    ...
    {
        if (TagHelper.Type != SmartSoftwareProgressBarType.Default)
        {
    ...
    {
        if (output.TagName == "ss-progress-part")
        {
            return;
        }
