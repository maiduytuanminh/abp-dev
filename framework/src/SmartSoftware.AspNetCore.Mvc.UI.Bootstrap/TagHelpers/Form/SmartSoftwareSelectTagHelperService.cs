...
public class SmartSoftwareSelectTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareSelectTagHelper>
{
    private readonly IHtmlGenerator _generator;
    private readonly HtmlEncoder _encoder;
    private readonly ISmartSoftwareTagHelperLocalizer _tagHelperLocalizer;
    private readonly IStringLocalizerFactory _stringLocalizerFactory;
    private readonly ISmartSoftwareEnumLocalizer _ssEnumLocalizer;

    public SmartSoftwareSelectTagHelperService(
        IHtmlGenerator generator,
        HtmlEncoder encoder,
        ISmartSoftwareTagHelperLocalizer tagHelperLocalizer,
        IStringLocalizerFactory stringLocalizerFactory,
        ISmartSoftwareEnumLocalizer ssEnumLocalizer)
    {
        _generator = generator;
        _encoder = encoder;
        _tagHelperLocalizer = tagHelperLocalizer;
        _stringLocalizerFactory = stringLocalizerFactory;
        _ssEnumLocalizer = ssEnumLocalizer;
    }
    ...
    protected virtual List<SelectListItem> GetSelectItemsFromEnum(TagHelperContext context, TagHelperOutput output, ModelExplorer explorer)
    {
        ...
        {
            var localizedMemberName = _ssEnumLocalizer.GetString(enumType, enumValue,
                new[]
                {
                    containerLocalizer,
    ...
    protected virtual string GetSize(TagHelperContext context, TagHelperOutput output)
    {
        ...
        {
            SmartSoftwareFormControlSize.Small => "form-select-sm",
            SmartSoftwareFormControlSize.Medium => "form-select-md",
            SmartSoftwareFormControlSize.Large => "form-select-lg",
            _ => "",
        };
    }
