...
public interface ISmartSoftwareDatePickerOptions
{
    ...
    /// </summary>
    SmartSoftwareDatePickerWeekNumbers WeekNumbers { get; set; }
    ...
    /// </summary>
    List<SmartSoftwareDatePickerRange>? Ranges { get; set; }
    ...
    /// </summary>
    SmartSoftwareDatePickerOpens Opens { get; set; }

    /// <summary>
    /// Whether the picker appears below (default) or above the HTML element it's attached to.
    /// </summary>
    SmartSoftwareDatePickerDrops Drops { get; set; }
