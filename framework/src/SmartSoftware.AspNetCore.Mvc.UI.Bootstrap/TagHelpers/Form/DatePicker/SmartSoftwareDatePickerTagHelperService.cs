...
public class SmartSoftwareDatePickerTagHelperService : SmartSoftwareDatePickerBaseTagHelperService<SmartSoftwareDatePickerTagHelper>
{
    public SmartSoftwareDatePickerTagHelperService(IJsonSerializer jsonSerializer, IHtmlGenerator generator, HtmlEncoder encoder, IServiceProvider serviceProvider, IStringLocalizer<SmartSoftwareUiResource> l, ISmartSoftwareTagHelperLocalizer tagHelperLocalizer) : base(jsonSerializer, generator, encoder, serviceProvider, l, tagHelperLocalizer)
    {
