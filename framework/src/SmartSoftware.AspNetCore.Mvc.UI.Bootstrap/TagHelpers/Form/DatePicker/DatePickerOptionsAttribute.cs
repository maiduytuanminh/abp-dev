...
public class DatePickerOptionsAttribute : Attribute
{
    ...
    public ISmartSoftwareDatePickerOptions? GetDatePickerOptions(ModelExplorer explorer)
    {
        ...
        return properties.FirstOrDefault(p=> p.Model is ISmartSoftwareDatePickerOptions)?.Model as ISmartSoftwareDatePickerOptions;
    }
}