...
public class SmartSoftwareDateRangePickerTagHelperService : SmartSoftwareDatePickerBaseTagHelperService<SmartSoftwareDateRangePickerTagHelper>
{
    public SmartSoftwareDateRangePickerTagHelperService(IJsonSerializer jsonSerializer, IHtmlGenerator generator,
    ...
    protected override string TagName { get; set; } = "ss-date-range-picker";
