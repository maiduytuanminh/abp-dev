...
public class SmartSoftwareInputTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareInputTagHelper>
{
    private readonly IHtmlGenerator _generator;
    private readonly HtmlEncoder _encoder;
    private readonly ISmartSoftwareTagHelperLocalizer _tagHelperLocalizer;

    public SmartSoftwareInputTagHelperService(IHtmlGenerator generator, HtmlEncoder encoder, ISmartSoftwareTagHelperLocalizer tagHelperLocalizer)
    {
    ...
    protected virtual string GetSize(TagHelperContext context, TagHelperOutput output)
    {
        ...
        {
            case SmartSoftwareFormControlSize.Small:
                return "form-control-sm";
            case SmartSoftwareFormControlSize.Medium:
                return "form-control-md";
            case SmartSoftwareFormControlSize.Large:
