...
[HtmlTargetElement(Attributes = "ss-id-name")]
public class SmartSoftwareIdNameTagHelper : SmartSoftwareTagHelper
{
    /// <summary>
    ...
    [HtmlAttributeName("ss-id-name")]
    public ModelExpression? IdNameFor { get; set; }

    private readonly MvcViewOptions _mvcViewOptions;

    public SmartSoftwareIdNameTagHelper(IOptions<MvcViewOptions> mvcViewOptions)
    {
