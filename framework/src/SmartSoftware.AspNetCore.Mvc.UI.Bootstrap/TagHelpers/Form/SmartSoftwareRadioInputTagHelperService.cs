...
public class SmartSoftwareRadioInputTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareRadioInputTagHelper>
{
    private readonly ISmartSoftwareTagHelperLocalizer _tagHelperLocalizer;

    public SmartSoftwareRadioInputTagHelperService(ISmartSoftwareTagHelperLocalizer tagHelperLocalizer)
    {
