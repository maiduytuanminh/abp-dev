...
public class SmartSoftwareColumnTagHelper : SmartSoftwareTagHelper<SmartSoftwareColumnTagHelper, SmartSoftwareColumnTagHelperService>
{
    ...
    public SmartSoftwareColumnTagHelper(SmartSoftwareColumnTagHelperService tagHelperService)
