...
public class SmartSoftwareBreadcrumbTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareBreadcrumbTagHelper>
{
    ...
    {
        return item.Active ?
            item.Html.Replace(SmartSoftwareBreadcrumbItemActivePlaceholder, " active") :
            item.Html.Replace(SmartSoftwareBreadcrumbItemActivePlaceholder, "");
    }
