...
public class SmartSoftwarePaginationTagHelperService : SmartSoftwareTagHelperService<SmartSoftwarePaginationTagHelper>
{
    ...
    public SmartSoftwarePaginationTagHelperService(
    ...
    {
        var localizer = _stringLocalizerFactory.Create(typeof(SmartSoftwareUiResource));
