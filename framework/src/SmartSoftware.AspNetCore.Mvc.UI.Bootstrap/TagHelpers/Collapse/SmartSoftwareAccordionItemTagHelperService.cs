...
public class SmartSoftwareAccordionItemTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareAccordionItemTagHelper>
{
    ...
    protected virtual string GetAccordionContentItem(TagHelperContext context, TagHelperOutput output, TagHelperContent content)
    {
        ...
        wrapper.Attributes.Add("data-bs-parent", "#" + SmartSoftwareAccordionParentIdPlaceholder);
