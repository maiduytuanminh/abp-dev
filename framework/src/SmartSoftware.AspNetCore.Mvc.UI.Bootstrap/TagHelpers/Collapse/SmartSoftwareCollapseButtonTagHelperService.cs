...
public class SmartSoftwareCollapseButtonTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareCollapseButtonTagHelper>
{
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        if (output.TagName == "ss-button" || output.TagName == "button")
        {
