...
public class SmartSoftwareCarouselItemTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareCarouselItemTagHelper>
{
    private readonly HtmlEncoder _encoder;

    public SmartSoftwareCarouselItemTagHelperService(HtmlEncoder encoder)
    {
        _encoder = encoder;
    }
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        output.Attributes.AddClass(SmartSoftwareCarouselItemActivePlaceholder);
