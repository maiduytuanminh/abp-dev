...
public class SmartSoftwareCarouselTagHelperService : SmartSoftwareTagHelperService<SmartSoftwareCarouselTagHelper>
{
    protected IStringLocalizer<SmartSoftwareUiResource> L { get; }

    public SmartSoftwareCarouselTagHelperService(IStringLocalizer<SmartSoftwareUiResource> localizer)
    {
        L = localizer;
    }
    ...
    {
        item.Html = item.Html.Replace(SmartSoftwareCarouselItemActivePlaceholder, item.Active ? "active" : "");
    }
