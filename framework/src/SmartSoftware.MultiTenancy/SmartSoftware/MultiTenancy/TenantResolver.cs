...
public class TenantResolver : ITenantResolver, ITransientDependency
{
    ...
    private readonly SmartSoftwareTenantResolveOptions _options;

    public TenantResolver(IOptions<SmartSoftwareTenantResolveOptions> options, IServiceProvider serviceProvider)
    {
