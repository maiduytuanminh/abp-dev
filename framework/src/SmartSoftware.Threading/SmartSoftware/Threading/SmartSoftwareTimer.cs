...
/// </summary>
public class SmartSoftwareTimer : ITransientDependency
{
    /// <summary>
    ...
    public ILogger<SmartSoftwareTimer> Logger { get; set; }
    ...
    public SmartSoftwareTimer()
    {
        ExceptionNotifier = NullExceptionNotifier.Instance;
        Logger = NullLogger<SmartSoftwareTimer>.Instance;
