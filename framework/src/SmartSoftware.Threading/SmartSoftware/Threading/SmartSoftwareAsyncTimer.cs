...
/// </summary>
public class SmartSoftwareAsyncTimer : ITransientDependency
{
    /// <summary>
    /// This func is raised periodically according to Period of Timer.
    /// </summary>
    public Func<SmartSoftwareAsyncTimer, Task> Elapsed = _ => Task.CompletedTask;
    ...
    public ILogger<SmartSoftwareAsyncTimer> Logger { get; set; }
    ...
    public SmartSoftwareAsyncTimer()
    {
        ExceptionNotifier = NullExceptionNotifier.Instance;
        Logger = NullLogger<SmartSoftwareAsyncTimer>.Instance;
    ...
    public void Start(CancellationToken cancellationToken = default)
    {
        if (Period <= 0)
        {
            throw new SmartSoftwareException("Period should be set before starting the timer!");
        }
