...
public class SmartSoftwareRedisCache : RedisCache, ICacheSupportsMultipleItems
{
    ...
    static SmartSoftwareRedisCache()
    {
    ...
    public SmartSoftwareRedisCache(IOptions<RedisCacheOptions> optionsAccessor)
