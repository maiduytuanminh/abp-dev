...
public class RebusDistributedEventBus : DistributedEventBusBase, ISingletonDependency
{
    ...
    protected SmartSoftwareRebusEventBusOptions SmartSoftwareRebusEventBusOptions { get; }
    ...
    public RebusDistributedEventBus(
        ...
        IOptions<SmartSoftwareRebusEventBusOptions> ssEventBusRebusOptions,
            ...
            correlationIdProvider)
    {
        ...
        SmartSoftwareRebusEventBusOptions = ssEventBusRebusOptions.Value;
    ...
    {
        if (SmartSoftwareRebusEventBusOptions.Publish != null)
        {
            await SmartSoftwareRebusEventBusOptions.Publish(Rebus, eventType, eventData);
            return;
        }
