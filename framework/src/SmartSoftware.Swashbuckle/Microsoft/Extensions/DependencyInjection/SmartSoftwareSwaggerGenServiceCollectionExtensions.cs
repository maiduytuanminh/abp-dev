...
public static class SmartSoftwareSwaggerGenServiceCollectionExtensions
{
    public static IServiceCollection AddSmartSoftwareSwaggerGen(
    ...
    public static IServiceCollection AddSmartSoftwareSwaggerGenWithOAuth(
        this IServiceCollection services,
    ...
    public static IServiceCollection AddSmartSoftwareSwaggerGenWithOidc(
        this IServiceCollection services,
        [NotNull] string authority,
        string[]? scopes = null,
        string[]? flows = null,
        ...
        Action<SwaggerGenOptions>? setupAction = null)
    {
        ...
        flows ??= new [] { SmartSoftwareSwaggerOidcFlows.AuthorizationCode };
