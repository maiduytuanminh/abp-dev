...
public static class ApplicationMenuExtensions
{
        ...
        string menuItemName)
    {
        ...
        if (menuItem == null)
        {
            throw new SmartSoftwareException($"Could not find a menu item with given name: {menuItemName}");
        }
        ...
        string groupName)
    {
        ...
        if (menuGroup == null)
        {
            throw new SmartSoftwareException($"Could not find a group item with given name: {groupName}");
        }
