...
public static class SmartSoftwareModelBuilderExtensions
{
    private const string ModelDatabaseProviderAnnotationKey = "_SmartSoftware_DatabaseProvider";
    private const string ModelMultiTenancySideAnnotationKey = "_SmartSoftware_MultiTenancySide";
