    ...
    where TEntity : class, IEntity
{
    ...
    protected virtual SmartSoftwareEntityOptions<TEntity> SmartSoftwareEntityOptions => _entityOptionsLazy.Value;

    private readonly IDbContextProvider<TDbContext> _dbContextProvider;
    private readonly Lazy<SmartSoftwareEntityOptions<TEntity>> _entityOptionsLazy;
    ...
    public EfCoreRepository(IDbContextProvider<TDbContext> dbContextProvider)
    {
        ...
        _entityOptionsLazy = new Lazy<SmartSoftwareEntityOptions<TEntity>>(
            () => ServiceProvider
                      .GetRequiredService<IOptions<SmartSoftwareEntityOptions>>()
                      .Value
                      .GetOrNull<TEntity>() ?? SmartSoftwareEntityOptions<TEntity>.Empty
        );
    }
    ...
    {
        if (SmartSoftwareEntityOptions.DefaultWithDetailsFunc == null)
        {
            return base.WithDetails();
        }

        return SmartSoftwareEntityOptions.DefaultWithDetailsFunc(GetQueryable());
    }
    ...
    public async override Task<IQueryable<TEntity>> WithDetailsAsync()
    {
        ...
        return SmartSoftwareEntityOptions.DefaultWithDetailsFunc(await GetQueryableAsync());
    }
