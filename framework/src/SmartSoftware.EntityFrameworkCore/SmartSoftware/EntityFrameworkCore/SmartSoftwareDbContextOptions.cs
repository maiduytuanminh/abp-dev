...
public class SmartSoftwareDbContextOptions
{
    internal List<Action<SmartSoftwareDbContextConfigurationContext>> DefaultPreConfigureActions { get; }

    internal Action<SmartSoftwareDbContextConfigurationContext>? DefaultConfigureAction { get; set; }
    ...
    public SmartSoftwareDbContextOptions()
    {
        DefaultPreConfigureActions = new List<Action<SmartSoftwareDbContextConfigurationContext>>();
    ...
    public void PreConfigure([NotNull] Action<SmartSoftwareDbContextConfigurationContext> action)
    {
    ...
    public void Configure([NotNull] Action<SmartSoftwareDbContextConfigurationContext> action)
    {
        Check.NotNull(action, nameof(action));
    ...
    public void PreConfigure<TDbContext>([NotNull] Action<SmartSoftwareDbContextConfigurationContext<TDbContext>> action)
        where TDbContext : SmartSoftwareDbContext<TDbContext>
    {
        Check.NotNull(action, nameof(action));
    ...
    public void Configure<TDbContext>([NotNull] Action<SmartSoftwareDbContextConfigurationContext<TDbContext>> action)
        where TDbContext : SmartSoftwareDbContext<TDbContext>
    {
        Check.NotNull(action, nameof(action));
