...
public static class SmartSoftwareClaimsIdentityExtensions
{
    public static Guid? FindUserId([NotNull] this ClaimsPrincipal principal)
    {
        Check.NotNull(principal, nameof(principal));

        var userIdOrNull = principal.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.UserId);
    ...
    public static Guid? FindUserId([NotNull] this IIdentity identity)
    {
        ...
        var userIdOrNull = claimsIdentity?.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.UserId);
        if (userIdOrNull == null || userIdOrNull.Value.IsNullOrWhiteSpace())
        {
            return null;
        }
    ...
    public static Guid? FindTenantId([NotNull] this ClaimsPrincipal principal)
    {
        ...
        var tenantIdOrNull = principal.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.TenantId);
    ...
    public static Guid? FindTenantId([NotNull] this IIdentity identity)
    {
        ...
        var tenantIdOrNull = claimsIdentity?.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.TenantId);
        if (tenantIdOrNull == null || tenantIdOrNull.Value.IsNullOrWhiteSpace())
        {
            return null;
        }
    ...
    public static string? FindClientId([NotNull] this ClaimsPrincipal principal)
    {
        ...
        var clientIdOrNull = principal.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.ClientId);
    ...
    public static string? FindClientId([NotNull] this IIdentity identity)
    {
        ...
        var clientIdOrNull = claimsIdentity?.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.ClientId);
        if (clientIdOrNull == null || clientIdOrNull.Value.IsNullOrWhiteSpace())
        {
            return null;
        }
    ...
    public static Guid? FindEditionId([NotNull] this ClaimsPrincipal principal)
    {
        ...
        var editionIdOrNull = principal.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.EditionId);
    ...
    public static Guid? FindEditionId([NotNull] this IIdentity identity)
    {
        ...
        var editionIdOrNull = claimsIdentity?.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.EditionId);
        if (editionIdOrNull == null || editionIdOrNull.Value.IsNullOrWhiteSpace())
        {
            return null;
        }
    ...
    public static Guid? FindImpersonatorTenantId([NotNull] this ClaimsPrincipal principal)
    {
        ...
        var impersonatorTenantIdOrNull = principal.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.ImpersonatorTenantId);
    ...
    public static Guid? FindImpersonatorTenantId([NotNull] this IIdentity identity)
    {
        ...
        var impersonatorTenantIdOrNull = claimsIdentity?.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.ImpersonatorTenantId);
        if (impersonatorTenantIdOrNull == null || impersonatorTenantIdOrNull.Value.IsNullOrWhiteSpace())
        {
            return null;
        }
    ...
    public static Guid? FindImpersonatorUserId([NotNull] this ClaimsPrincipal principal)
    {
        ...
        var impersonatorUserIdOrNull = principal.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.ImpersonatorUserId);
    ...
    public static Guid? FindImpersonatorUserId([NotNull] this IIdentity identity)
    {
        ...
        var impersonatorUserIdOrNull = claimsIdentity?.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.ImpersonatorUserId);
        if (impersonatorUserIdOrNull == null || impersonatorUserIdOrNull.Value.IsNullOrWhiteSpace())
        {
            return null;
        }
    ...
    public static string? FindSessionId([NotNull] this IIdentity identity)
    {
        ...
        var sessionIdOrNull = claimsIdentity?.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.SessionId);
    ...
    public static string? FindSessionId([NotNull] this ClaimsPrincipal principal)
    {
        ...
        var sessionIdOrNull = principal.Claims?.FirstOrDefault(c => c.Type == SmartSoftwareClaimTypes.SessionId);
        if (sessionIdOrNull == null || sessionIdOrNull.Value.IsNullOrWhiteSpace())
        {
            return null;
        }
