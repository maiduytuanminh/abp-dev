...
public static class CurrentUserExtensions
{
    ...
    {
        var impersonatorTenantId = currentUser.FindClaimValue(SmartSoftwareClaimTypes.ImpersonatorTenantId);
    ...
    {
        var impersonatorUserId = currentUser.FindClaimValue(SmartSoftwareClaimTypes.ImpersonatorUserId);
    ...
    {
        return currentUser.FindClaimValue(SmartSoftwareClaimTypes.ImpersonatorTenantName);
    }

    public static string? FindImpersonatorUserName([NotNull] this ICurrentUser currentUser)
    {
        return currentUser.FindClaimValue(SmartSoftwareClaimTypes.ImpersonatorUserName);
    }
    ...
    {
        return currentUser.FindClaimValue(SmartSoftwareClaimTypes.SessionId);
    }
}
