...
public class ClientProxyRequestPayloadBuilder : ITransientDependency
{
    ...
    public ClientProxyRequestPayloadBuilder(IServiceScopeFactory serviceScopeFactory, IOptions<SmartSoftwareHttpClientProxyingOptions> httpClientProxyingOptions)
    {
