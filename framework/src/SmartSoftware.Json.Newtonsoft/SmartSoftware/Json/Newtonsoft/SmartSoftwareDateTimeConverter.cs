...
public class SmartSoftwareDateTimeConverter : DateTimeConverterBase, ITransientDependency
{
    ...
    public SmartSoftwareDateTimeConverter(IClock clock, IOptions<SmartSoftwareJsonOptions> options)
    {
        _clock = clock;
