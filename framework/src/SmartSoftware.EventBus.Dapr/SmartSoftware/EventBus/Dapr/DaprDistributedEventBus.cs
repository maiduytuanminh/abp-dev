...
public class DaprDistributedEventBus : DistributedEventBusBase, ISingletonDependency
{
    ...
    protected SmartSoftwareDaprEventBusOptions DaprEventBusOptions { get; }
    ...
    public DaprDistributedEventBus(
        ...
        IOptions<SmartSoftwareDaprEventBusOptions> daprEventBusOptions,
    ...
    protected virtual async Task PublishToDaprAsync(string eventName, object eventData, Guid? messageId = null, string? correlationId = null)
    {
        ...
        var data = new SmartSoftwareDaprEventData(DaprEventBusOptions.PubSubName, eventName, (messageId ?? GuidGenerator.Create()).ToString("N"), Serializer.SerializeToString(eventData), correlationId);
