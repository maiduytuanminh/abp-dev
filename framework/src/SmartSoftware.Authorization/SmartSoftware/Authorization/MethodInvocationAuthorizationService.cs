...
public class MethodInvocationAuthorizationService : IMethodInvocationAuthorizationService, ITransientDependency
{
    ...
    private readonly ISmartSoftwareAuthorizationService _ssAuthorizationService;

    public MethodInvocationAuthorizationService(
        ISmartSoftwareAuthorizationPolicyProvider ssAuthorizationPolicyProvider,
        ISmartSoftwareAuthorizationService ssAuthorizationService)
    {
        _ssAuthorizationPolicyProvider = ssAuthorizationPolicyProvider;
        _ssAuthorizationService = ssAuthorizationService;
    }
    ...
    public async Task CheckAsync(MethodInvocationAuthorizationContext context)
    {
        ...
        var authorizationPolicy = await AuthorizationPolicy.CombineAsync(
            _ssAuthorizationPolicyProvider,
        ...
        await _ssAuthorizationService.CheckAsync(authorizationPolicy);
    }
