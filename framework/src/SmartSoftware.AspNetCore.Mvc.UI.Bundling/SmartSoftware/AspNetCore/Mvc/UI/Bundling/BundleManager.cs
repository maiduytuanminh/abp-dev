...
using SmartSoftware.AspNetCore.Mvc.UI.Bundling.Scripts;
using SmartSoftware.AspNetCore.Mvc.UI.Bundling.Styles;
using SmartSoftware.AspNetCore.Mvc.UI.Resources;
...
public class BundleManager : IBundleManager, ITransientDependency
{
    ...
    protected readonly SmartSoftwareBundlingOptions Options;
    protected readonly SmartSoftwareBundleContributorOptions ContributorOptions;
    ...
    public BundleManager(
        ...
        IOptions<SmartSoftwareBundleContributorOptions> contributorOptions,
    ...
    protected virtual bool IsBundlingEnabled()
    {
        switch (Options.Mode)
        {
            ...
            default:
                throw new SmartSoftwareException($"Unhandled {nameof(BundlingMode)}: {Options.Mode}");
        }
    }
