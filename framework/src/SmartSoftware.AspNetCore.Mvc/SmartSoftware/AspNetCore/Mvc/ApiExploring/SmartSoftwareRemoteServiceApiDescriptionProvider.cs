...
public class SmartSoftwareRemoteServiceApiDescriptionProvider : IApiDescriptionProvider, ITransientDependency
{
    private readonly IModelMetadataProvider _modelMetadataProvider;
    private readonly MvcOptions _mvcOptions;
    private readonly SmartSoftwareRemoteServiceApiDescriptionProviderOptions _options;

    public SmartSoftwareRemoteServiceApiDescriptionProvider(
        IModelMetadataProvider modelMetadataProvider,
        IOptions<MvcOptions> mvcOptionsAccessor,
        IOptions<SmartSoftwareRemoteServiceApiDescriptionProviderOptions> optionsAccessor)
    {
