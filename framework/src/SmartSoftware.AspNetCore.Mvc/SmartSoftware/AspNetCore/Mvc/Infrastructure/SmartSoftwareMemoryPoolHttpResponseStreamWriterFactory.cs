...
namespace SmartSoftware.AspNetCore.Mvc.Infrastructure;

/// <summary>
/// https://github.com/dotnet/aspnetcore/issues/40928#issuecomment-1450063613
/// </summary>
public class SmartSoftwareMemoryPoolHttpResponseStreamWriterFactory : IHttpResponseStreamWriterFactory
{
    ...
    public SmartSoftwareMemoryPoolHttpResponseStreamWriterFactory(ArrayPool<byte> bytePool, ArrayPool<char> charPool)
    {
