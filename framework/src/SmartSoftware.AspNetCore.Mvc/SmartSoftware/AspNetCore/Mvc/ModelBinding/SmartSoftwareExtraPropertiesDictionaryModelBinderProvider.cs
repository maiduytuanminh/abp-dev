...
public class SmartSoftwareExtraPropertiesDictionaryModelBinderProvider : IModelBinderProvider
{
    public IModelBinder? GetBinder(ModelBinderProviderContext context)
    {
        ...
        var valueBinder = new SmartSoftwareExtraPropertyModelBinder(context.Metadata.ContainerType);
