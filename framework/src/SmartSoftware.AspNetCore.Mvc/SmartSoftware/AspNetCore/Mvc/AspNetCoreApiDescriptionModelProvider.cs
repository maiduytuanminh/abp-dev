...
using SmartSoftware.AspNetCore.Mvc.Utils;
...
public class AspNetCoreApiDescriptionModelProvider : IApiDescriptionModelProvider, ITransientDependency
{
    ...
    private readonly SmartSoftwareAspNetCoreMvcOptions _ssAspNetCoreMvcOptions;
    private readonly SmartSoftwareApiDescriptionModelOptions _modelOptions;

    public AspNetCoreApiDescriptionModelProvider(
        IOptions<AspNetCoreApiDescriptionModelProviderOptions> options,
        IApiDescriptionGroupCollectionProvider descriptionProvider,
        IOptions<SmartSoftwareAspNetCoreMvcOptions> ssAspNetCoreMvcOptions,
        IOptions<SmartSoftwareApiDescriptionModelOptions> modelOptions)
    {
        _options = options.Value;
        _descriptionProvider = descriptionProvider;
        _ssAspNetCoreMvcOptions = ssAspNetCoreMvcOptions.Value;
    ...
    {
        foreach (var controllerSetting in _ssAspNetCoreMvcOptions.ConventionalControllers.ConventionalControllerSettings)
        {
