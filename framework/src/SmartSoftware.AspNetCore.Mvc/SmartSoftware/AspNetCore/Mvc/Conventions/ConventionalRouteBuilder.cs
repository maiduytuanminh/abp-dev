...
{
    protected SmartSoftwareConventionalControllerOptions Options { get; }

    public ConventionalRouteBuilder(IOptions<SmartSoftwareConventionalControllerOptions> options)
    {
    ...
    protected virtual string GetApiRoutePrefix(ActionModel actionModel, ConventionalControllerSetting? configuration)
    {
        ...
        {
            return SmartSoftwareAspNetCoreConsts.DefaultIntegrationServiceApiPrefix;
        }

        return SmartSoftwareAspNetCoreConsts.DefaultApiPrefix;
    }
