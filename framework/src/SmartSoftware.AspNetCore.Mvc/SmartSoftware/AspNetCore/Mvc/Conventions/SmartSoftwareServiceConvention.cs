...
public class SmartSoftwareServiceConvention : ISmartSoftwareServiceConvention, ITransientDependency
{
    public ILogger<SmartSoftwareServiceConvention> Logger { get; set; }

    protected SmartSoftwareAspNetCoreMvcOptions Options { get; }
    protected IConventionalRouteBuilder ConventionalRouteBuilder { get; }

    public SmartSoftwareServiceConvention(
        ...
        IConventionalRouteBuilder conventionalRouteBuilder)
    {
        ...
        Logger = NullLogger<SmartSoftwareServiceConvention>.Instance;
    }
    ...
    protected virtual void ConfigureSelector(string rootPath, string controllerName, ActionModel action, ConventionalControllerSetting? configuration)
    {
        ...
        {
            AddSmartSoftwareServiceSelector(rootPath, controllerName, action, configuration);
        }
        else
        {
    ...
    protected virtual void AddSmartSoftwareServiceSelector(string rootPath, string controllerName, ActionModel action, ConventionalControllerSetting? configuration)
    {
        var httpMethod = SelectHttpMethod(action, configuration);

        var ssServiceSelectorModel = new SelectorModel
        {
            AttributeRouteModel = CreateSmartSoftwareServiceAttributeRouteModel(rootPath, controllerName, action, httpMethod, configuration),
    ...
    protected virtual void NormalizeSelectorRoutes(string rootPath, string controllerName, ActionModel action, ConventionalControllerSetting? configuration)
    {
        foreach (var selector in action.Selectors)
        {
            ...
            {
                selector.AttributeRouteModel = CreateSmartSoftwareServiceAttributeRouteModel(rootPath, controllerName, action, httpMethod, configuration);
            }
    ...
    protected virtual AttributeRouteModel CreateSmartSoftwareServiceAttributeRouteModel(string rootPath, string controllerName, ActionModel action, string httpMethod, ConventionalControllerSetting? configuration)
    {
