...
public class SmartSoftwareValidateAntiForgeryTokenAttribute : Attribute, IFilterFactory, IOrderedFilter
{
    /// <summary>
    ...
    {
        return serviceProvider.GetRequiredService<SmartSoftwareValidateAntiforgeryTokenAuthorizationFilter>();
    }
}
