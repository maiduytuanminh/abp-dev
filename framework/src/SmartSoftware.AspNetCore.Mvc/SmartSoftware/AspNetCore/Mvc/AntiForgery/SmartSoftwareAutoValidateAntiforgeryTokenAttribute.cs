...
public class SmartSoftwareAutoValidateAntiforgeryTokenAttribute : Attribute, IFilterFactory, IOrderedFilter
{
    /// <summary>
    ...
    {
        return serviceProvider.GetRequiredService<SmartSoftwareAutoValidateAntiforgeryTokenAuthorizationFilter>();
    }
}
