...
public class SmartSoftwareDataAnnotationAutoLocalizationMetadataDetailsProvider : IDisplayMetadataProvider
{
    ...
    public SmartSoftwareDataAnnotationAutoLocalizationMetadataDetailsProvider(IServiceCollection services)
    {
