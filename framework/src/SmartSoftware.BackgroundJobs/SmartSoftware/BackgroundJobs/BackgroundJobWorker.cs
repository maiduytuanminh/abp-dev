...
{
    protected const string DistributedLockName = "SmartSoftwareBackgroundJobWorker";

    protected SmartSoftwareBackgroundJobOptions JobOptions { get; }

    protected SmartSoftwareBackgroundJobWorkerOptions WorkerOptions { get; }

    protected ISmartSoftwareDistributedLock DistributedLock { get; }

    public BackgroundJobWorker(
        SmartSoftwareAsyncTimer timer,
        IOptions<SmartSoftwareBackgroundJobOptions> jobOptions,
        IOptions<SmartSoftwareBackgroundJobWorkerOptions> workerOptions,
