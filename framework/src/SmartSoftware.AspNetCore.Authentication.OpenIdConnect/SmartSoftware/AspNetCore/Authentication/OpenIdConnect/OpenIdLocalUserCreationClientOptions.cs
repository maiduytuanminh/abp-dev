...
public class OpenIdLocalUserCreationClientOptions
{
    ...
    /// <summary>
    /// Default value: "SmartSoftwareIdentity".
    /// Fallbacks to the "Default" remote service configuration, if "SmartSoftwareIdentity" configuration is not available.
    ...
    /// </summary>
    public string RemoteServiceName { get; set; } = "SmartSoftwareIdentity";
