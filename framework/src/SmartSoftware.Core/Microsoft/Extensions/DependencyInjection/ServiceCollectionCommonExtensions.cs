...
public static class ServiceCollectionCommonExtensions
{
    ...
    public static IServiceProvider BuildServiceProviderFromFactory<TContainerBuilder>([NotNull] this IServiceCollection services, Action<TContainerBuilder>? builderAction = null) where TContainerBuilder : notnull
    {
        ...
        {
            throw new SmartSoftwareException($"Could not find {typeof(IServiceProviderFactory<TContainerBuilder>).FullName} in {services}.");
        }
    ...
    {
        return services
            .GetSingletonInstance<ISmartSoftwareApplication>()
            .ServiceProvider
            .GetService<T>();
    }
