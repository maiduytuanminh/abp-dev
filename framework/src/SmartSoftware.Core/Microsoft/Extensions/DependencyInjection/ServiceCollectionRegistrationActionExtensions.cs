...
public static class ServiceCollectionRegistrationActionExtensions
{
    ...
    public static void DisableSmartSoftwareClassInterceptors(this IServiceCollection services)
    {
        GetOrCreateRegistrationActionList(services).IsClassInterceptorsDisabled = true;
    }

    public static bool IsSmartSoftwareClassInterceptorsDisabled(this IServiceCollection services)
    {
