...
public interface ISmartSoftwareApplication :
    IModuleContainer,
    ...
    IDisposable
{
    ...
    /// If you use this method, you must have set the <see cref="SmartSoftwareApplicationCreationOptions.SkipConfigureServices"/>
