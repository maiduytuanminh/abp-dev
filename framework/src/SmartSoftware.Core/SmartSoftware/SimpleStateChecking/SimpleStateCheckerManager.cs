    ...
    where TState : IHasSimpleStateCheckers<TState>
{
    ...
    protected SmartSoftwareSimpleStateCheckerOptions<TState> Options { get; }

    public SimpleStateCheckerManager(IServiceProvider serviceProvider, IOptions<SmartSoftwareSimpleStateCheckerOptions<TState>> options)
    {
