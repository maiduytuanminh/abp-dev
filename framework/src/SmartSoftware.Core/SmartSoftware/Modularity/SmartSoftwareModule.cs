...
public abstract class SmartSoftwareModule :
    ISmartSoftwareModule,
    ...
    IPostConfigureServices
{
    ...
    protected internal ServiceConfigurationContext ServiceConfigurationContext {
        get {
            ...
            {
                throw new SmartSoftwareException($"{nameof(ServiceConfigurationContext)} is only available in the {nameof(ConfigureServices)}, {nameof(PreConfigureServices)} and {nameof(PostConfigureServices)} methods.");
            }
    ...
    public static bool IsSmartSoftwareModule(Type type)
    {
        ...
        return
            ...
            typeof(ISmartSoftwareModule).GetTypeInfo().IsAssignableFrom(type);
    }

    internal static void CheckSmartSoftwareModuleType(Type moduleType)
    {
        if (!IsSmartSoftwareModule(moduleType))
        {
            throw new ArgumentException("Given type is not an SS module: " + moduleType.AssemblyQualifiedName);
        }
    }
