...
/// </summary>
[ExposeServices(typeof(ISmartSoftwareLazyServiceProvider))]
public class SmartSoftwareLazyServiceProvider :
    CachedServiceProviderBase,
    ISmartSoftwareLazyServiceProvider,
    ITransientDependency
{
    public SmartSoftwareLazyServiceProvider(IServiceProvider serviceProvider)
