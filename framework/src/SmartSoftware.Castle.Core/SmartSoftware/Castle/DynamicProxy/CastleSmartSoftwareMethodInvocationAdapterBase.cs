...
public abstract class CastleSmartSoftwareMethodInvocationAdapterBase : ISmartSoftwareMethodInvocation
{
    ...
    protected CastleSmartSoftwareMethodInvocationAdapterBase(IInvocation invocation)
    {
