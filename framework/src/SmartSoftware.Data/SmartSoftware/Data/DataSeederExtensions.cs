...
public static class DataSeederExtensions
{
    ...
    public static Task SeedInSeparateUowAsync(this IDataSeeder seeder, Guid? tenantId = null, SmartSoftwareUnitOfWorkOptions? options = null, bool requiresNew = false)
    {
