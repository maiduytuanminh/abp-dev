...
//TODO: Create a SmartSoftware.Data.Filtering namespace?
    ...
    where TFilter : class
{
    ...
    private readonly SmartSoftwareDataFilterOptions _options;

    private readonly AsyncLocal<DataFilterState> _filter;

    public DataFilter(IOptions<SmartSoftwareDataFilterOptions> options)
    {
