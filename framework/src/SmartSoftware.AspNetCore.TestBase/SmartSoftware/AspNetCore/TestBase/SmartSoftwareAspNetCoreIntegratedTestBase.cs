...
/// </typeparam>
[Obsolete("Use SmartSoftwareWebApplicationFactoryIntegratedTest instead.")]
public abstract class SmartSoftwareAspNetCoreIntegratedTestBase<TStartupModule> : SmartSoftwareTestBaseWithServiceProvider, IDisposable
    where TStartupModule : class
{
    ...
    protected SmartSoftwareAspNetCoreIntegratedTestBase()
    {
    ...
    protected virtual IHostBuilder CreateHostBuilder()
    {
        return Host.CreateDefaultBuilder()
            ...
            {
                if (typeof(TStartupModule).IsAssignableTo<ISmartSoftwareModule>())
                {
                ...
                webBuilder.UseSmartSoftwareTestServer();
            })
            .UseAutofac()
