...
public abstract class SmartSoftwareWebApplicationFactoryIntegratedTest<TProgram> : WebApplicationFactory<TProgram>
    where TProgram : class
{
    ...
    protected SmartSoftwareWebApplicationFactoryIntegratedTest()
    {
