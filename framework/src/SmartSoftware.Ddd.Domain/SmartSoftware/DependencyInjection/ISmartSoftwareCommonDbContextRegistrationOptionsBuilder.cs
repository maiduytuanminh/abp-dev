...
public interface ISmartSoftwareCommonDbContextRegistrationOptionsBuilder
{
    ...
    /// </param>
    ISmartSoftwareCommonDbContextRegistrationOptionsBuilder AddDefaultRepositories(bool includeAllEntities = false);
    ...
    /// </param>
    ISmartSoftwareCommonDbContextRegistrationOptionsBuilder AddDefaultRepositories<TDefaultRepositoryDbContext>(bool includeAllEntities = false);
    ...
    /// Set <see cref="includeAllEntities"/> to true to include all entities.
    /// </param>
    ISmartSoftwareCommonDbContextRegistrationOptionsBuilder AddDefaultRepositories(Type defaultRepositoryDbContextType, bool includeAllEntities = false);

    /// <summary>
    /// Registers default repository for a specific entity.
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    ISmartSoftwareCommonDbContextRegistrationOptionsBuilder AddDefaultRepository<TEntity>();
    ...
    /// <returns></returns>
    ISmartSoftwareCommonDbContextRegistrationOptionsBuilder AddDefaultRepository(Type entityType);
    ...
    ISmartSoftwareCommonDbContextRegistrationOptionsBuilder AddRepository<TEntity, TRepository>();
    ...
    /// <returns></returns>
    ISmartSoftwareCommonDbContextRegistrationOptionsBuilder SetDefaultRepositoryClasses([NotNull] Type repositoryImplementationType, [NotNull] Type repositoryImplementationTypeWithoutKey);
    ...
    ISmartSoftwareCommonDbContextRegistrationOptionsBuilder ReplaceDbContext<TOtherDbContext>(MultiTenancySides multiTenancySides = MultiTenancySides.Both);
    ...
    /// <param name="multiTenancySides">MultiTenancy side</param>
    ISmartSoftwareCommonDbContextRegistrationOptionsBuilder ReplaceDbContext<TOtherDbContext, TTargetDbContext>(MultiTenancySides multiTenancySides = MultiTenancySides.Both);
    ...
    /// <param name="multiTenancySides">MultiTenancy side</param>
    ISmartSoftwareCommonDbContextRegistrationOptionsBuilder ReplaceDbContext(Type otherDbContextType, Type? targetDbContextType = null, MultiTenancySides multiTenancySides = MultiTenancySides.Both);
}
