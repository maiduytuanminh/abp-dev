...
{
    private const string UnitOfWorkEventRecordEntityPropName = "_SmartSoftware_Entity";
    ...
    protected SmartSoftwareDistributedEntityEventOptions DistributedEntityEventOptions { get; }

    public EntityChangeEventHelper(
        IUnitOfWorkManager unitOfWorkManager,
        IEntityToEtoMapper entityToEtoMapper,
        IOptions<SmartSoftwareDistributedEntityEventOptions> distributedEntityEventOptions)
    {
