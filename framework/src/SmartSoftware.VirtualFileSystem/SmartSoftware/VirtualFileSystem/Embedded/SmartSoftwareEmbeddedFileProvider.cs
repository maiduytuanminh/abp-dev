...
namespace SmartSoftware.VirtualFileSystem.Embedded;

public class SmartSoftwareEmbeddedFileProvider : DictionaryBasedFileProvider
{
    [NotNull]
    ...
    public SmartSoftwareEmbeddedFileProvider(
