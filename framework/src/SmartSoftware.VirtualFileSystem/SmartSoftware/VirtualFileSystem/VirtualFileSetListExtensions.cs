...
using SmartSoftware.VirtualFileSystem.Embedded;
using SmartSoftware.VirtualFileSystem.Physical;
...
public static class VirtualFileSetListExtensions
{
        ...
        string? baseFolder = null)
    {
        ...
        if (info == null)
        {
            return new SmartSoftwareEmbeddedFileProvider(assembly, baseNamespace);
        }
