...
public class MultiTenancyMiddleware : SmartSoftwareMiddlewareBase, ITransientDependency
{
    ...
    public async override Task InvokeAsync(HttpContext context, RequestDelegate next)
    {
        ...
        if (tenant?.Id != _currentTenant.Id)
        {
            using (_currentTenant.Change(tenant?.Id, tenant?.Name))
            {
                ...
                {
                    SmartSoftwareMultiTenancyCookieHelper.SetTenantCookie(context, _currentTenant.Id, _options.TenantKey);
                }
                ...
                if (requestCulture != null)
                {
                    ...
                    context.Items[SmartSoftwareRequestLocalizationMiddleware.HttpContextItemName] = true;
                }
