...
public class SmartSoftwareAspNetCoreMultiTenancyOptions
{
    /// <summary>
    ...
    public SmartSoftwareAspNetCoreMultiTenancyOptions()
    {
        ...
        MultiTenancyMiddlewareErrorPageBuilder = async (context, exception) =>
        {
            ...
            if (tenantResolveResult != null)
            {
                ...
                var options = context.RequestServices.GetRequiredService<IOptions<SmartSoftwareAspNetCoreMultiTenancyOptions>>().Value;
                    ...
                    context.Request.Cookies.ContainsKey(options.TenantKey))
                {
                    ...
                    SmartSoftwareMultiTenancyCookieHelper.SetTenantCookie(context, null, options.TenantKey);
                }
            }

            context.Response.Headers.Add("SmartSoftware-Tenant-Resolve-Error", HtmlEncoder.Default.Encode(exception.Message));
