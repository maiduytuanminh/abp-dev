...
public abstract class SmartSoftwarePageModel : PageModel
{
    ...
    protected virtual IStringLocalizer CreateLocalizer()
    {
        ...
        if (localizer == null)
        {
            throw new SmartSoftwareException($"Set {nameof(LocalizationResourceType)} or define the default localization resource type (by configuring the {nameof(SmartSoftwareLocalizationOptions)}.{nameof(SmartSoftwareLocalizationOptions.DefaultResourceType)}) to be able to use the {nameof(L)} object!");
        }
