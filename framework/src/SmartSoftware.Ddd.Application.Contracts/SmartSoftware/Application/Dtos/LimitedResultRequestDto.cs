...
namespace SmartSoftware.Application.Dtos;
...
public class LimitedResultRequestDto : ILimitedResultRequest, IValidatableObject
{
    ...
    public virtual IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        {
            var localizer = validationContext.GetRequiredService<IStringLocalizer<SmartSoftwareDddApplicationContractsResource>>();
