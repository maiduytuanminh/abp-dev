...
namespace SmartSoftware.Cli.ServiceProxying.CSharp;
...
public class CSharpServiceProxyGenerator : ServiceProxyGeneratorBase<CSharpServiceProxyGenerator>, ITransientDependency
{
    ...
    private const string AppServicePrefix = "SmartSoftware.Application.Services";
    ...
    private readonly static string ClassTemplate = "// This file is automatically generated by SS framework to use MVC Controllers from CSharp" +
    ...
    private readonly static string InterfaceTemplate = "// This file is automatically generated by SS framework to use MVC Controllers from CSharp" +
                                                       $"{Environment.NewLine}<using>" +
                                                       $"{Environment.NewLine}" +
                                                       $"{Environment.NewLine}// ReSharper disable once CheckNamespace" +
                                                       $"{Environment.NewLine}namespace <namespace>;" +
    ...
    private readonly static string DtoTemplate = "// This file is automatically generated by SS framework to use MVC Controllers from CSharp" +
                                                 $"{Environment.NewLine}<using>" +
                                                 $"{Environment.NewLine}" +
                                                 $"{Environment.NewLine}// ReSharper disable once CheckNamespace" +
                                                 $"{Environment.NewLine}namespace <namespace>;" +
    ...
    private async Task GenerateDtoFileAsync(GenerateProxyArgs args, ApplicationApiDescriptionModel applicationApiDescriptionModel)
    {
        ...
        for (var i = 0; i < types.Count; i++)
        {
            ...
            if (className.StartsWith("SmartSoftware.Application.Dtos.") && className.Contains("<") && className.Contains(">"))
            {
