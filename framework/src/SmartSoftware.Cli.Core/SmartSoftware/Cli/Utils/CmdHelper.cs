...
public class CmdHelper : ICmdHelper, ITransientDependency
{
    ...
    protected SmartSoftwareCliOptions CliOptions { get; }
    
    public CmdHelper(IOptionsSnapshot<SmartSoftwareCliOptions> cliOptions)
    {
    ...
    public string GetFileName()
    {
        ...
        throw new SmartSoftwareException($"Cannot determine shell command for this OS! " +
