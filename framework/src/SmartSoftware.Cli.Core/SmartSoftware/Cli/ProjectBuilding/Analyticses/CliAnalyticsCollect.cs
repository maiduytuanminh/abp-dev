...
public class CliAnalyticsCollect : ICliAnalyticsCollect, ITransientDependency
{
    ...
    public async Task CollectAsync(CliAnalyticsCollectInputDto input)
    {
        ...
        var url = $"{CliUrls.WwwSmartSoftwareIo}api/clianalytics/collect";
        ...
        try
        {
            ...
            if (!responseMessage.IsSuccessStatusCode)
            {
                ...
                var remoteServiceErrorMessage = await _remoteServiceExceptionHandler.GetSmartSoftwareRemoteServiceErrorAsync(responseMessage);
