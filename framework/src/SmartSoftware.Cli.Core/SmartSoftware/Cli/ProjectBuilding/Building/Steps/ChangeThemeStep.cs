...
public class ChangeThemeStep : ProjectBuildPipelineStep
{
    ...
    private static void ChangeThemeToBasicForBlazorProjects(ProjectBuildContext context, string defaultThemeName)
    {
        ReplacePackageReferenceWithProjectReference(
            ...
            $"SmartSoftware.AspNetCore.Components.WebAssembly.{defaultThemeName}Theme",
            @"..\..\..\..\..\modules\basic-theme\src\SmartSoftware.AspNetCore.Components.WebAssembly.BasicTheme\SmartSoftware.AspNetCore.Components.WebAssembly.BasicTheme.csproj"
        );
        ...
        ReplacePackageReferenceWithProjectReference(
            ...
            $"SmartSoftware.AspNetCore.Mvc.UI.Theme.{defaultThemeName}",
            @"..\..\..\..\..\modules\basic-theme\src\SmartSoftware.AspNetCore.Mvc.UI.Theme.Basic\SmartSoftware.AspNetCore.Mvc.UI.Theme.Basic.csproj"
        );
    ...
    private static void ChangeThemeToLeptonForBlazorProjects(ProjectBuildContext context)
    {
        ReplacePackageReferenceWithProjectReference(
            ...
            "SmartSoftware.AspNetCore.Components.WebAssembly.LeptonXTheme",
            @"..\..\..\..\..\lepton-theme\src\SmartSoftware.AspNetCore.Components.WebAssembly.LeptonTheme\SmartSoftware.AspNetCore.Components.WebAssembly.LeptonTheme.csproj"
        );
        ...
        ReplacePackageReferenceWithProjectReference(
            ...
            "SmartSoftware.AspNetCore.Mvc.UI.Theme.LeptonX",
            @"..\..\..\..\..\lepton-theme\src\SmartSoftware.AspNetCore.Mvc.UI.Theme.Lepton\SmartSoftware.AspNetCore.Mvc.UI.Theme.Lepton.csproj"
        );
    ...
    private static void ConfigureLeptonManagementPackagesForNoLayersMvc(ProjectBuildContext context, string targetProjectPath, IEnumerable<string> projectNames)
    {
        ...
        foreach (var projectName in projectNames)
        {
            ...
            AddProjectReference(file, $@"..\..\..\..\lepton-theme\src\SmartSoftware.LeptonTheme.Management.{projectName}\SmartSoftware.LeptonTheme.Management.{projectName}.csproj");
    ...
    {
        var reference = $@"..\..\..\..\..\lepton-theme\src\SmartSoftware.LeptonTheme.Management.{projectInfo.Key}\SmartSoftware.LeptonTheme.Management.{projectInfo.Key}.csproj";
    ...
    private static void AddModuleDependency(FileEntry moduleFile, string projectName, string dependency, bool underManagementFolder = true)
    {
        ...
        for (var i = 0; i < lines.Length; i++)
        {
            ...
            {
                lines[i - 1] = lines[i - 1] + ("using SmartSoftware.LeptonTheme" + (underManagementFolder ? ".Management." : ".") + (projectNames.Any(p => p == projectName) ? projectName : "")).TrimEnd('.').EnsureEndsWith(';') + Environment.NewLine;
            }
    ...
    private static void ChangeThemeToBasicForBlazorServerProjects(ProjectBuildContext context, string defaultThemeName)
    {
        ...
        foreach (var project in projects)
        {
            ReplacePackageReferenceWithProjectReference(
                ...
                $"SmartSoftware.AspNetCore.Components.Server.{defaultThemeName}",
                @"..\..\..\..\..\modules\basic-theme\src\SmartSoftware.AspNetCore.Components.Server.BasicTheme\SmartSoftware.AspNetCore.Components.Server.BasicTheme.csproj"
            );
    ...
    private static void ChangeThemeToLeptonForBlazorServerProjects(ProjectBuildContext context)
    {
        ...
        foreach (var projectName in projectNames)
        {
            ...
            ReplacePackageReferenceWithProjectReference(
                context,
                $"/MyCompanyName.MyProjectName.{projectName}/MyCompanyName.MyProjectName.{projectName}.csproj",
                "SmartSoftware.AspNetCore.Components.Server.LeptonXTheme",
                @"..\..\..\..\..\lepton-theme\src\SmartSoftware.AspNetCore.Components.Server.LeptonTheme\SmartSoftware.AspNetCore.Components.Server.LeptonTheme.csproj"
            );
    ...
    private static void ChangeThemeToLeptonForMauiBlazorProjects(ProjectBuildContext context)
    {
        ReplacePackageReferenceWithProjectReference(
            ...
            "SmartSoftware.AspNetCore.Components.MauiBlazor.LeptonXTheme",
            @"..\..\..\..\..\lepton-theme\src\SmartSoftware.AspNetCore.Components.MauiBlazor.LeptonTheme\SmartSoftware.AspNetCore.Components.MauiBlazor.LeptonTheme.csproj"
        );

        ReplaceAllKeywords(
            context,
            "/MyCompanyName.MyProjectName.MauiBlazor/MainPage.xaml",
            "clr-namespace:SmartSoftware.AspNetCore.Components.Web.LeptonXTheme.Components;assembly=SmartSoftware.AspNetCore.Components.Web.LeptonXTheme",
            "clr-namespace:SmartSoftware.AspNetCore.Components.Web.LeptonTheme.Components;assembly=SmartSoftware.AspNetCore.Components.Web.LeptonTheme");
        ...
        ReplaceAllKeywords(
            ...
            "SmartSoftware.AspNetCore.Components.MauiBlazor.LeptonXTheme.Components.AccountLayout",
            "SmartSoftware.AspNetCore.Components.MauiBlazor.LeptonTheme.Components.AccountLayout");
        ...
        ReplaceAllKeywords(
            context,
            "/MyCompanyName.MyProjectName.MauiBlazor/Pages/Account/RedirectToLogout.razor",
            "SmartSoftware.LeptonX.Shared.Localization",
            "SmartSoftware.LeptonTheme.Management.Localization");
