...
public abstract class AppTemplateBase : TemplateInfo
{
    ...
    protected void SetDbmsSymbols(ProjectBuildContext context)
    {
        switch (context.BuildArgs.DatabaseManagementSystem)
        {
            ...
            case DatabaseManagementSystem.SQLite:
                ...
                break;
            default:
                throw new SmartSoftwareException("Unknown Dbms: " + context.BuildArgs.DatabaseManagementSystem);
        }
    }
    ...
    {
        var mvcUiPackageName = isProTemplate ? "@smartsoftware/smartsoftware.aspnetcore.mvc.ui.theme.leptonx" : "@smartsoftware/aspnetcore.mvc.ui.theme.leptonxlite";
        ...
        {
            var blazorServerUiPackageName = isProTemplate ? "@smartsoftware/aspnetcore.components.server.leptonxtheme" : "@smartsoftware/aspnetcore.components.server.leptonxlitetheme";
        ...
        {
            var ngUiPackageName = isProTemplate ? "@smartsoftware/ss.ng.theme.lepton-x" : "@smartsoftware/ng.theme.lepton-x";
    ...
    protected static void RemoveCmsKitDependenciesFromPackageJsonFiles(List<ProjectBuildPipelineStep> steps)
    {
        ...
        {
            steps.Add(new RemoveDependencyFromPackageJsonFileStep(packageJsonFile, "@smartsoftware/cms-kit-pro.admin"));
        }

        foreach (var packageJsonFile in publicCmsPackageInstalledProjectsPackageJsonFiles)
        {
            steps.Add(new RemoveDependencyFromPackageJsonFileStep(packageJsonFile, "@smartsoftware/cms-kit-pro.public"));
        }
    }
