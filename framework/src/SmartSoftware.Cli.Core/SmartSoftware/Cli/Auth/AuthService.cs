...
public class AuthService : IAuthService, ITransientDependency
{
    ...
    public async Task<LoginInfo> GetLoginInfoAsync()
    {
        ...
        var url = $"{CliUrls.WwwSmartSoftwareIo}api/license/login-info";
    ...
    public async Task LoginAsync(string userName, string password, string organizationName = null)
    {
        var configuration = new IdentityClientConfiguration(
            CliUrls.AccountSmartSoftwareIo,
            "ssio offline_access",
            "ss-cli",
            null,
        ...
        {
            configuration["[o]ss-organization-name"] = organizationName;
        }
    ...
    {
        var url = $"{CliUrls.WwwSmartSoftwareIo}api/license/check-multiple-organizations?username={username}";
