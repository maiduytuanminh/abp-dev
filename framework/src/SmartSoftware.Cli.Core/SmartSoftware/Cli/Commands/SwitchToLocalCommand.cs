...
public class SwitchToLocal : IConsoleCommand, ITransientDependency
{
    ...
    public string GetUsageInfo()
    {
        ...
        sb.AppendLine("Usage:");
        sb.AppendLine("");
        sb.AppendLine("  ss switch-to-local [options]");
        sb.AppendLine("");
        ...
        sb.AppendLine("");
        sb.AppendLine("  ss switch-to-local --paths D:\\Github\\ss");
        sb.AppendLine("  ss switch-to-local --paths D:\\Github\\ss --solution D:\\test\\MyProject");
        sb.AppendLine("  ss switch-to-local --paths \"D:\\Github\\ss|D:\\Github\\smartsoftware\"");
