...
public class GenerateProxyCommand : ProxyCommandBase<GenerateProxyCommand>
{
    ...
    public override string GetUsageInfo()
    {
        ...
        sb.AppendLine("");
        sb.AppendLine("  ss generate-proxy -t ng");
        sb.AppendLine("  ss generate-proxy -t js -m identity -o Pages/Identity/client-proxies.js -url https://localhost:44302/");
        sb.AppendLine("  ss generate-proxy -t csharp --folder MyProxies/InnerFolder -url https://localhost:44302/");
        sb.AppendLine("  ss generate-proxy -t csharp -url https://localhost:44302/ --without-contracts");
