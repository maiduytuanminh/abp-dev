...
public abstract class ProjectCreationCommandBase
{
        ...
        if (preview)
        {
            ...
            if (!cliVersion.IsPrerelease)
            {
                throw new CliUsageException(
                    ...
                    " Update your SS CLI to the preview version.");
            }
#endif
        }
    ...
    protected void OpenThanksPage(UiFramework uiFramework, DatabaseProvider databaseProvider, bool tiered, bool commercial)
    {
        ...
        var url = $"https://{urlPrefix}.smartsoftware.io/project-created-success?ui={uiFramework:g}&db={databaseProvider:g}&tiered={tieredYesNo}";
    ...
    {
        var url = "https://docs.smartsoftware.io/en/commercial/latest/startup-templates/microservice/index";
        ...
        bool isOverride = true)
    {
        ...
        var commandBuilder = new StringBuilder($"npx ng g @smartsoftware/ng.schematics:create-lib --package-name {libraryName}");
