...
public class AddPackageCommand : IConsoleCommand, ITransientDependency
{
    ...
    public string GetUsageInfo()
    {
        ...
        sb.AppendLine("");
        sb.AppendLine("'add-package' command is used to add an SS package to a project.");
        sb.AppendLine("It should be used in a folder containing a .csproj file, .sln file or angular.json.");
        sb.AppendLine("");
        sb.AppendLine("Usage:");
        sb.AppendLine("");
        sb.AppendLine("  ss add-package <package-name> [options]");
        sb.AppendLine("");
        ...
        sb.AppendLine("  -v|--version <version>                                Specifies the version of the package. Default is your project's SS version or latest SS version.");
        sb.AppendLine("");
        sb.AppendLine("Examples:");
        sb.AppendLine("");
        sb.AppendLine("  ss add-package SmartSoftware.FluentValidation                                  Adds the NuGet package to the current project.");
        sb.AppendLine("  ss add-package SmartSoftware.FluentValidation -p Acme.BookStore.Application    Adds the NuGet package to the given project.");
        sb.AppendLine("  ss add-package @smartsoftware/ng.theme.basic                                        Adds the NPM package to the given corresponding project.");
        sb.AppendLine("");
    ...
    {
        return "Add a new SS package to a project by adding related NuGet package dependencies and [DependsOn(...)] attributes.";
    }
