...
namespace SmartSoftware.Cli.Commands.Internal;
...
public class RecreateInitialMigrationCommand : IConsoleCommand, ITransientDependency
{
    ...
    {
        return "This is a internal command. Please run 'ss recreate-initial-migration' command in ss or smartsoftware root directory.";
    }
}
