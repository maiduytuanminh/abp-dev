...
public class SourceCodeDownloadService : ITransientDependency
{
    ...
    public async Task DownloadModuleAsync(string moduleName, string outputFolder, string version, string gitHubSmartSoftwareLocalRepositoryPath, SmartSoftwareCommandLineOptions options)
    {
