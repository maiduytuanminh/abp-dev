...
//TODO: Move to SmartSoftware.Data.ObjectExtending namespace at v3.0
...
public static class HasExtraPropertiesExtensions
{
    ...
    public static TProperty? GetProperty<TProperty>(this IHasExtraProperties source, string name, TProperty? defaultValue = default)
    {
        ...
        throw new SmartSoftwareException("GetProperty<TProperty> does not support non-primitive types. Use non-generic GetProperty method and handle type casting manually.");
    }
