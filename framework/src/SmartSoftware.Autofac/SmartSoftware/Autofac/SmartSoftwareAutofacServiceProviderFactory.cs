...
/// </summary>
public class SmartSoftwareAutofacServiceProviderFactory : IServiceProviderFactory<ContainerBuilder>
{
    private readonly ContainerBuilder _builder;
    private IServiceCollection _services = default!;

    public SmartSoftwareAutofacServiceProviderFactory(ContainerBuilder builder)
    {
        _builder = builder;
    }
