...
{
    public const string UowCacheName = "SmartSoftwareDistributedCache";
    ...
    private readonly SmartSoftwareDistributedCacheOptions _distributedCacheOption;

    public DistributedCache(
        IOptions<SmartSoftwareDistributedCacheOptions> distributedCacheOption,
    ...
    protected virtual KeyValuePair<TCacheKey, TCacheItem?>[] ToCacheItems(byte[]?[] itemBytes, TCacheKey[] itemKeys)
    {
        ...
        {
            throw new SmartSoftwareException("count of the item bytes should be same with the count of the given keys");
        }
    ...
    protected virtual Dictionary<TCacheKey, UnitOfWorkCacheItem<TCacheItem>> GetUnitOfWorkCache()
    {
        ...
        {
            throw new SmartSoftwareException($"There is no active UOW.");
        }
