...
public static class SmartSoftwareAspNetCoreApplicationBuilderExtensions
{
    /// <summary>
    /// Maps endpoints configured with the <see cref="SmartSoftwareEndpointRouterOptions"/>.
        ...
        Action<IEndpointRouteBuilder>? additionalConfigurationAction = null)
    {
        var options = app.ApplicationServices
            .GetRequiredService<IOptions<SmartSoftwareEndpointRouterOptions>>()
            .Value;
