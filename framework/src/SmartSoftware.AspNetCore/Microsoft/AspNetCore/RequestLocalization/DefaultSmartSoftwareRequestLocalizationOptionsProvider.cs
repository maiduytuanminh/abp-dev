...
public class DefaultSmartSoftwareRequestLocalizationOptionsProvider : ISmartSoftwareRequestLocalizationOptionsProvider, ISingletonDependency
{
    ...
    public DefaultSmartSoftwareRequestLocalizationOptionsProvider(IServiceScopeFactory serviceProviderFactory)
    {
                ...
                if (_requestLocalizationOptions == null)
                {
                    using (var serviceScope = _serviceProviderFactory.CreateScope())
                    {
                        ...
                        foreach (var configurator in serviceScope.ServiceProvider
                            .GetRequiredService<IOptions<SmartSoftwareRequestLocalizationOptions>>()
