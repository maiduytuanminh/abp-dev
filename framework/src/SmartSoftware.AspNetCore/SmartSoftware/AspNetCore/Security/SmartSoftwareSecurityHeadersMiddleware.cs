...
public class SmartSoftwareSecurityHeadersMiddleware : SmartSoftwareMiddlewareBase, ITransientDependency
{
    public IOptions<SmartSoftwareSecurityHeadersOptions> Options { get; set; }
    ...
    public SmartSoftwareSecurityHeadersMiddleware(IOptions<SmartSoftwareSecurityHeadersOptions> options)
    {
        Options = options;
    }
    ...
    public async override Task InvokeAsync(HttpContext context, RequestDelegate next)
    {
        ...
        if (endpoint?.Metadata.GetMetadata<IgnoreSmartSoftwareSecurityHeaderAttribute>() != null)
        {
        ...
        if (Options.Value.UseContentSecurityPolicyScriptNonce)
        {
            ...
            context.Items.Add(SmartSoftwareAspNetCoreConsts.ScriptNonceKey, randomValue);
        }
    ...
    protected virtual string BuildContentSecurityPolicyValue(HttpContext context)
    {
        ...
        if (!(Options.Value.UseContentSecurityPolicyScriptNonce &&
              context.Items.TryGetValue(SmartSoftwareAspNetCoreConsts.ScriptNonceKey, out var nonce) &&
