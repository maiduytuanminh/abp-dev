...
public class SmartSoftwareUnitOfWorkMiddleware : SmartSoftwareMiddlewareBase, ITransientDependency
{
    private readonly IUnitOfWorkManager _unitOfWorkManager;
    private readonly SmartSoftwareAspNetCoreUnitOfWorkOptions _options;

    public SmartSoftwareUnitOfWorkMiddleware(
        IUnitOfWorkManager unitOfWorkManager,
        IOptions<SmartSoftwareAspNetCoreUnitOfWorkOptions> options)
    {
