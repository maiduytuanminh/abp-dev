...
public class SmartSoftwareMongoDbDateTimeSerializer : DateTimeSerializer
{
    protected DateTimeKind DateTimeKind { get; set; }
    protected bool DisableDateTimeNormalization { get; set; }

    public SmartSoftwareMongoDbDateTimeSerializer(DateTimeKind dateTimeKind, bool disableDateTimeNormalization)
    {
