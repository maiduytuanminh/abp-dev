...
public class MongoModelSource : IMongoModelSource, ISingletonDependency
{
    ...
    public virtual MongoDbContextModel GetModel(SmartSoftwareMongoDbContext dbContext)
    {
    ...
    protected virtual MongoDbContextModel CreateModel(SmartSoftwareMongoDbContext dbContext)
    {
    ...
    protected virtual void BuildModelFromDbContextInstance(IMongoModelBuilder modelBuilder, SmartSoftwareMongoDbContext dbContext)
    {
