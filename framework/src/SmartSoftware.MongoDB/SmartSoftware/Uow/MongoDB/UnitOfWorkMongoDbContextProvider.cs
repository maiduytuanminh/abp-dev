    ...
    where TMongoDbContext : ISmartSoftwareMongoDbContext
{
    ...
    protected readonly SmartSoftwareMongoDbContextOptions Options;
    ...
    public UnitOfWorkMongoDbContextProvider(
        ...
        IOptions<SmartSoftwareMongoDbContextOptions> options,
    ...
    private TMongoDbContext CreateDbContext(IUnitOfWork unitOfWork, MongoUrl mongoUrl, string databaseName)
    {
        ...
        dbContext.ToSmartSoftwareMongoDbContext().InitializeDatabase(database, client, null);
        ...
        IMongoDatabase database)
    {
        ...
        if (activeTransaction?.SessionHandle == null)
        {
            ...
            dbContext.ToSmartSoftwareMongoDbContext().InitializeDatabase(database, client, session);
        }
        else
        {
            dbContext.ToSmartSoftwareMongoDbContext().InitializeDatabase(database, client, activeTransaction.SessionHandle);
        }
