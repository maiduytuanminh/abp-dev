...
public class QuartzJobExecutionAdapter<TArgs> : IJob
{
    ...
    protected SmartSoftwareBackgroundJobQuartzOptions BackgroundJobQuartzOptions { get; }
    ...
    public QuartzJobExecutionAdapter(
        ...
        IOptions<SmartSoftwareBackgroundJobQuartzOptions> backgroundJobQuartzOptions,
