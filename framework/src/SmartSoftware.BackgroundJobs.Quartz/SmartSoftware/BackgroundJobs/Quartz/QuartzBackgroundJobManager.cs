...
{
    public const string JobDataPrefix = "SmartSoftware";
    public const string RetryIndex = "RetryIndex";

    protected IScheduler Scheduler { get; }

    protected SmartSoftwareBackgroundJobQuartzOptions Options { get; }

    protected IJsonSerializer JsonSerializer { get; }

    public QuartzBackgroundJobManager(IScheduler scheduler, IOptions<SmartSoftwareBackgroundJobQuartzOptions> options, IJsonSerializer jsonSerializer)
    {
        Scheduler = scheduler;
