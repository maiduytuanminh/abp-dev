...
public class SmartSoftwareBlazorClientHttpMessageHandler : DelegatingHandler, ITransientDependency
{
    ...
    public SmartSoftwareBlazorClientHttpMessageHandler(
