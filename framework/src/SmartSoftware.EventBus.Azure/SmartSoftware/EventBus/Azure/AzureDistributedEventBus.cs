...
{
    protected SmartSoftwareAzureEventBusOptions Options { get; }
    ...
    public AzureDistributedEventBus(
        ...
        IClock clock,
        IOptions<SmartSoftwareAzureEventBusOptions> ssAzureEventBusOptions,
    ...
    {
        Options = ssAzureEventBusOptions.Value;
        ...
        foreach (var outgoingEvent in outgoingEventArray)
        {
            ...
            if (!messageBatch.TryAddMessage(message))
            {
                throw new SmartSoftwareException(
                    "The message is too large to fit in the batch. Set SmartSoftwareEventBusBoxesOptions.OutboxWaitingEventMaxCount to reduce the number");
            }
