...
public interface IPermissionDefinitionContext
{
    ...
    /// Throws <see cref="SmartSoftwareException"/> if can not find the given group.
    /// </summary>
    ...
    /// Throws <see cref="SmartSoftwareException"/> if there is a group with the name.
    /// <param name="name">Name of the group</param>
    ...
    /// Throws <see cref="SmartSoftwareException"/> if there is not any group with the name.
    /// <param name="name">Name of the group</param>
    /// </summary>
