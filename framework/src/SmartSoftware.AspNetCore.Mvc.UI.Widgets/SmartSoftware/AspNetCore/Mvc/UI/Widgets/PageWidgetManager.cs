...
{
    public const string HttpContextItemName = "__SmartSoftwareCurrentWidgets";
    ...
    private List<WidgetDefinition> GetWidgetList()
    {
        ...
        if (httpContext == null)
        {
            throw new SmartSoftwareException($"{typeof(PageWidgetManager).AssemblyQualifiedName} should be used in a web request! Can not get IHttpContextAccessor.HttpContext.");
        }
