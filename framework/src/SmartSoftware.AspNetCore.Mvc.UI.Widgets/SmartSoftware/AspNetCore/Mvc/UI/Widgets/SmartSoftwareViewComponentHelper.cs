...
public class SmartSoftwareViewComponentHelper : IViewComponentHelper, IViewContextAware, ITransientDependency
{
    ...
    public SmartSoftwareViewComponentHelper(
        DefaultViewComponentHelper defaultViewComponentHelper,
        IOptions<SmartSoftwareWidgetOptions> widgetOptions,
    ...
    protected virtual async Task<IHtmlContent> InvokeWidgetAsync(object? arguments, WidgetDefinition widget)
    {
        ...
        var wrapperAttributesBuilder = new StringBuilder($"class=\"ss-widget-wrapper\" data-widget-name=\"{widget.Name}\"");
