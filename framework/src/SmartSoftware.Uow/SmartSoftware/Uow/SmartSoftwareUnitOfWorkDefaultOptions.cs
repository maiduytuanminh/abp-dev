...
/// </summary>
public class SmartSoftwareUnitOfWorkDefaultOptions
{
    /// <summary>
    ...
    internal SmartSoftwareUnitOfWorkOptions Normalize(SmartSoftwareUnitOfWorkOptions options)
    {
    ...
    public bool CalculateIsTransactional(bool autoValue)
    {
        switch (TransactionBehavior)
        {
            ...
            case UnitOfWorkTransactionBehavior.Auto:
                return autoValue;
            default:
                throw new SmartSoftwareException("Not implemented TransactionBehavior value: " + TransactionBehavior);
        }
    }
}
