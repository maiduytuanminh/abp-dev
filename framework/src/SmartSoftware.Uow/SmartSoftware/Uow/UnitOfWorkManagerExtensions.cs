...
public static class UnitOfWorkManagerExtensions
{
        ...
        int? timeout = null)
    {
        ...
        return unitOfWorkManager.Begin(new SmartSoftwareUnitOfWorkOptions
        {
    ...
    public static void BeginReserved([NotNull] this IUnitOfWorkManager unitOfWorkManager, [NotNull] string reservationName)
    {
        ...
        unitOfWorkManager.BeginReserved(reservationName, new SmartSoftwareUnitOfWorkOptions());
    }
    ...
    public static void TryBeginReserved([NotNull] this IUnitOfWorkManager unitOfWorkManager, [NotNull] string reservationName)
    {
        ...
        unitOfWorkManager.TryBeginReserved(reservationName, new SmartSoftwareUnitOfWorkOptions());
    }
}
