...
public class UnitOfWork : IUnitOfWork, ITransientDependency
{
    ...
    public const string UnitOfWorkReservationName = "_SmartSoftwareActionUnitOfWork";

    public Guid Id { get; } = Guid.NewGuid();

    public ISmartSoftwareUnitOfWorkOptions Options { get; private set; } = default!;
    ...
    private readonly SmartSoftwareUnitOfWorkDefaultOptions _defaultOptions;
    ...
    public virtual void Initialize(SmartSoftwareUnitOfWorkOptions options)
    {
        Check.NotNull(options, nameof(options));

        if (Options != null)
        {
            throw new SmartSoftwareException("This unit of work has already been initialized.");
        }
    ...
    public virtual void AddDatabaseApi(string key, IDatabaseApi api)
    {
        ...
        {
            throw new SmartSoftwareException("This unit of work already contains a database API for the given key.");
        }
    ...
    public virtual void AddTransactionApi(string key, ITransactionApi api)
    {
        ...
        {
            throw new SmartSoftwareException("This unit of work already contains a transaction API for the given key.");
        }
    ...
    private void PreventMultipleComplete()
    {
        ...
        {
            throw new SmartSoftwareException("Completion has already been requested for this unit of work.");
        }
    }
