...
public class RegularTestControllerClientProxy_Tests : SmartSoftwareHttpClientTestBase
{
    ...
    {
        var exception = await Assert.ThrowsAsync<SmartSoftwareRemoteCallException>(async () => await _controller.GetException1Async());
    ...
    {
        var exception = await Assert.ThrowsAsync<SmartSoftwareRemoteCallException>(async () => await _controller.GetException2Async());
    ...
    public async Task AbortRequestAsync()
    {
        ...
        var exception = await Assert.ThrowsAsync<SmartSoftwareRemoteCallException>(async () => await _controller.AbortRequestAsync(cts.Token));
