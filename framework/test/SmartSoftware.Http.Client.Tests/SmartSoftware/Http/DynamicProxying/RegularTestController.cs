...
[RemoteService] //Automatically enables API explorer and apply SS conventions.
//[ApiExplorerSettings(IgnoreApi = false)] //alternative
public class RegularTestController : SmartSoftwareController, IRegularTestController
{
    [HttpGet]
    [Route("increment")]
    ...
    {
        throw new BusinessException("SmartSoftware.Http.DynamicProxying:10001")
            .WithData("0","TEST");
    }
