...
/// </summary>
[DependsOn(
    typeof(SmartSoftwareBlobStoringAwsModule),
    typeof(SmartSoftwareBlobStoringTestModule)
)]
public class SmartSoftwareBlobStoringAwsTestCommonModule : SmartSoftwareModule
{
}

[DependsOn(
    typeof(SmartSoftwareBlobStoringAwsTestCommonModule)
)]
public class SmartSoftwareBlobStoringAwsTestModule : SmartSoftwareModule
{
    private const string UserSecretsId = "9f0d2c00-80c1-435b-bfab-2c39c8249091";

    private readonly string _randomContainerName = "ss-aws-test-container-" + Guid.NewGuid().ToString("N");
