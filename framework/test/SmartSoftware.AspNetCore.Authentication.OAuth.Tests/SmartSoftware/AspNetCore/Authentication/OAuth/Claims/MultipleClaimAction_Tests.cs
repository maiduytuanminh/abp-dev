...
namespace SmartSoftware.AspNetCore.Authentication.OAuth.Claims;
...
public class MultipleClaimAction_Tests
{
  ...
  ""role"": ""admin""
        ...
        new MultipleClaimAction(SmartSoftwareClaimTypes.Role, "role").Run(jObject.RootElement, claimsIdentity, null);
        var claims = claimsIdentity.FindAll(SmartSoftwareClaimTypes.Role).ToList();
