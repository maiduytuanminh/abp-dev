...
public class SmartSoftwareAspNetCoreTestBase : SmartSoftwareAspNetCoreTestBase<Program>
{
}

public abstract class SmartSoftwareAspNetCoreTestBase<TProgram> : SmartSoftwareWebApplicationFactoryIntegratedTest<TProgram>
