...
public class RazorTemplateRendererProvider_Tests : SmartSoftwareTextTemplatingTestBase<RazorTextTemplatingTestModule>
{
    ...
    public async Task Should_Get_Rendered_Localized_Template_Content_With_Different_Cultures()
    {
        (await _templateRenderer.RenderAsync(
            ...
            cultureName: "en"
        )).ShouldBe("Welcome John to the smartsoftware.io!");
        ...
        (await _templateRenderer.RenderAsync(
            ...
            cultureName: "tr"
        )).ShouldBe("Merhaba John, smartsoftware.io'ya hoşgeldiniz!");
    ...
    public async Task Should_Get_Rendered_Inline_Localized_Template()
    {
        (await _templateRenderer.RenderAsync(
            ...
            cultureName: "en"
        )).ShouldBe("*BEGIN*Hello John, how are you?. Please click to the following link to get an email to reset your password!<a target=\"_blank\" href=\"https://smartsoftware.io/Account/ResetPassword\">Reset your password</a>*END*");

        (await _templateRenderer.RenderAsync(
            TestTemplates.ForgotPasswordEmail,
            new ForgotPasswordEmailModel("John"),
            cultureName: "tr"
        )).ShouldBe("*BEGIN*Merhaba John, nasılsın?. Please click to the following link to get an email to reset your password!<a target=\"_blank\" href=\"https://smartsoftware.io/Account/ResetPassword\">Reset your password</a>*END*");
    }
