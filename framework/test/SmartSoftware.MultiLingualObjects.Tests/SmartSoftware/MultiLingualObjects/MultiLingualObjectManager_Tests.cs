...
using SmartSoftware.MultiLingualObjects.TestObjects;
using SmartSoftware.Testing;
using Xunit;

namespace SmartSoftware.MultiLingualObjects;

public class MultiLingualObjectManager_Tests : SmartSoftwareIntegratedTest<SmartSoftwareMultiLingualObjectsTestModule>
{
