...
namespace SmartSoftware.EntityFrameworkCore.ChangeTracking;

public class ChangeTrackingInterceptor_Tests : TestAppTestBase<SmartSoftwareEntityFrameworkCoreTestModule>
{
    [Fact]
