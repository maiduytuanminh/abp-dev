...
namespace SmartSoftware.EntityFrameworkCore.DomainEvents;

public class DomainEvents_Tests : DomainEvents_Tests<SmartSoftwareEntityFrameworkCoreTestModule>
{
}

public class SmartSoftwareEntityChangeOptions_DomainEvents_Tests : SmartSoftwareEntityChangeOptions_DomainEvents_Tests<SmartSoftwareEntityFrameworkCoreTestModule>
{
}

public class SmartSoftwareEfCoreDomainEvents_Tests : EntityFrameworkCoreTestBase
{
    ...
    public SmartSoftwareEfCoreDomainEvents_Tests()
    {
