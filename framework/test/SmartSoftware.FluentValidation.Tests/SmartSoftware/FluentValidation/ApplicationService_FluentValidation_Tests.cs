...
public class ApplicationService_FluentValidation_Tests : SmartSoftwareIntegratedTest<ApplicationService_FluentValidation_Tests.TestModule>
{
    ...
    public async Task Should_Not_Work_With_Wrong_Inputs()
    {
        ...
        var exception = await Assert.ThrowsAsync<SmartSoftwareValidationException>(
        ...
        exception = await Assert.ThrowsAsync<SmartSoftwareValidationException>(async () => await _myAppService.MyMethodAsync(
            new MyMethodInput
            {
                MyStringValue = "a",
                MyMethodInput2 = new MyMethodInput2
    ...
    [DependsOn(typeof(SmartSoftwareFluentValidationModule))]
