...
public class MenuManager_Tests : SmartSoftwareIntegratedTest<SmartSoftwareUiNavigationTestModule>
{
    ...
    public class TestMenuContributor3 : IMenuContributor
    {
        ...
        public Task ConfigureMenuAsync(MenuConfigurationContext context)
        {
            ...
            products.AddItem(new ApplicationMenuItem("SS", "SS", url: "/products/ss"));
