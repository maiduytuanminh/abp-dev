...
public abstract class SmartSoftwareEntityChangeOptions_DomainEvents_Tests<TStartupModule> : TestAppTestBase<TStartupModule>
    where TStartupModule : ISmartSoftwareModule
{
    protected readonly IRepository<AppEntityWithNavigations, Guid> AppEntityWithNavigationsRepository;
    ...
    protected SmartSoftwareEntityChangeOptions_DomainEvents_Tests()
    {
        AppEntityWithNavigationsRepository = GetRequiredService<IRepository<AppEntityWithNavigations, Guid>>();
    ...
    {
        services.Configure<SmartSoftwareEntityChangeOptions>(options =>
        {
