...
[DependsOn(
    typeof(SmartSoftwareBlobStoringMinioModule),
    typeof(SmartSoftwareBlobStoringTestModule)
)]
public class SmartSoftwareBlobStoringMinioTestCommonModule : SmartSoftwareModule
{

}

[DependsOn(
    typeof(SmartSoftwareBlobStoringMinioTestCommonModule)
)]
public class SmartSoftwareBlobStoringMinioTestModule : SmartSoftwareModule
{
    ...
    private readonly string _randomContainerName = "ss-minio-test-container-" + Guid.NewGuid().ToString("N");
