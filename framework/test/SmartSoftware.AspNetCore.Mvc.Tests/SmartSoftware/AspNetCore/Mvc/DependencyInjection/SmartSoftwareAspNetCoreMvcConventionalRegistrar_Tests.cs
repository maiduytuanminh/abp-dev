...
namespace SmartSoftware.AspNetCore.Mvc.DependencyInjection;

public class SmartSoftwareAspNetCoreMvcConventionalRegistrar_Tests
{
    [Fact]
    public void Should_Registered_Mvc_Service()
    {
        ...
        services.AddConventionalRegistrar(new SmartSoftwareAspNetCoreMvcConventionalRegistrar());
