...
[DependsOn(
    typeof(SmartSoftwareBlobStoringAliyunModule),
    typeof(SmartSoftwareBlobStoringTestModule)
)]
public class SmartSoftwareBlobStoringAliyunTestCommonModule : SmartSoftwareModule
{

}

[DependsOn(
    typeof(SmartSoftwareBlobStoringAliyunTestCommonModule)
)]
public class SmartSoftwareBlobStoringAliyunTestModule : SmartSoftwareModule
{
    ...
    private readonly string _randomContainerName = "ss-aliyun-test-container-" + Guid.NewGuid().ToString("N");
