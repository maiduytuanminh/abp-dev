...
public class SmartSoftwareAutoMapperModule_Specific_ObjectMapper_Tests : SmartSoftwareIntegratedTest<AutoMapperTestModule>
{
    private readonly IObjectMapper _objectMapper;

    public SmartSoftwareAutoMapperModule_Specific_ObjectMapper_Tests()
    {
