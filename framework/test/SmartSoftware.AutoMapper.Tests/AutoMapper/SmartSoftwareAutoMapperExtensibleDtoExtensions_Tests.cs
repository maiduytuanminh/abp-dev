...
public class SmartSoftwareAutoMapperExtensibleDtoExtensions_Tests : SmartSoftwareIntegratedTest<AutoMapperTestModule>
{
    private readonly SmartSoftware.ObjectMapping.IObjectMapper _objectMapper;

    public SmartSoftwareAutoMapperExtensibleDtoExtensions_Tests()
    {
        _objectMapper = ServiceProvider.GetRequiredService<SmartSoftware.ObjectMapping.IObjectMapper>();
    }
