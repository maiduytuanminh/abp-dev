...
public class SmartSoftwareLocalization_Tests : SmartSoftwareIntegratedTest<SmartSoftwareLocalizationTestModule>
{
    private readonly IStringLocalizer<LocalizationTestResource> _localizer;
    private readonly IStringLocalizerFactory _localizerFactory;

    public SmartSoftwareLocalization_Tests()
    {
    ...
    [Fact]
    public void SmartSoftwareStringLocalizerExtensions_GetInternalLocalizer()
    {
        var internalLocalizer = _localizer.GetInternalLocalizer();
        internalLocalizer.ShouldNotBeNull();
        internalLocalizer.ShouldBeOfType<SmartSoftwareDictionaryBasedStringLocalizer>();
    }

    [Fact]
    public void SmartSoftwareStringLocalizerExtensions_GetInternalLocalizer_Using_LocalizerFactory()
    {
