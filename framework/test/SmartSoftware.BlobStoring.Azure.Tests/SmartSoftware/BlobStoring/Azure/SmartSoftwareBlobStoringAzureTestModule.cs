...
/// </summary>
[DependsOn(
    typeof(SmartSoftwareBlobStoringAzureModule),
    typeof(SmartSoftwareBlobStoringTestModule)
)]
public class SmartSoftwareBlobStoringAzureTestCommonModule : SmartSoftwareModule
{

}

[DependsOn(
    typeof(SmartSoftwareBlobStoringAzureTestCommonModule)
)]
public class SmartSoftwareBlobStoringAzureTestModule : SmartSoftwareModule
{
    private const string UserSecretsId = "9f0d2c00-80c1-435b-bfab-2c39c8249091";

    private string _connectionString;

    private readonly string _randomContainerName = "ss-azure-test-container-" + Guid.NewGuid().ToString("N");
