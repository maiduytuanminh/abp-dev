...
public class InputAndOutputDateTimeFormatSystemTextJsonTests : SmartSoftwareJsonSystemTextJsonTestBase
{
    ...
    protected override void AfterAddApplication(IServiceCollection services)
    {
        ...
        services.Configure<SmartSoftwareClockOptions>(options =>
        {
...
public class InputAndOutputDateTimeFormatNewtonsoftTests : SmartSoftwareJsonNewtonsoftJsonTestBase
{
    private readonly IJsonSerializer _jsonSerializer;
