...
public class Auditing_Tests : SmartSoftwareAuditingTestBase
{
...
public class Auditing_DisableLogActionInfo_Tests : Auditing_Tests
{
    protected override void AfterAddApplication(IServiceCollection services)
    {
        services.Configure<SmartSoftwareAuditingOptions>(options =>
        {
...
public class Auditing_SaveEntityHistoryWhenNavigationChanges_Tests : SmartSoftwareAuditingTestBase
{
    protected IAuditingStore AuditingStore;
    private IAuditingManager _auditingManager;
    private IUnitOfWorkManager _unitOfWorkManager;
