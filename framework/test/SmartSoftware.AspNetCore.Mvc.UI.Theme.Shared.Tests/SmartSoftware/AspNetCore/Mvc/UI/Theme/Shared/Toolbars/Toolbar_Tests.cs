...
namespace SmartSoftware.AspNetCore.Mvc.UI.Theme.Shared.Tests.SmartSoftware.AspNetCore.Mvc.UI.Theme.Shared.Toolbars;

public class Toolbar_Tests : SmartSoftwareAspNetCoreMvcUiThemeSharedTestBase
{
    protected override void ConfigureServices(IServiceCollection services)
    {
        services.Configure<SmartSoftwareToolbarOptions>(options =>
        {
    ...
    [Fact]
    public void SmartSoftwareToolbarOptions_Should_Contain_Contributors()
    {
        var options = GetRequiredService<IOptions<SmartSoftwareToolbarOptions>>().Value;
    ...
    public class MyComponent1 : SmartSoftwareViewComponent
    {
    ...
    public class MyComponent2 : SmartSoftwareViewComponent
    {
        public IViewComponentResult InvokeAsync()
        {
    ...
    public class MyComponent3 : SmartSoftwareViewComponent
    {
        public IViewComponentResult InvokeAsync()
        {
    ...
    public class MyComponent4 : SmartSoftwareViewComponent
    {
        public IViewComponentResult InvokeAsync()
        {
