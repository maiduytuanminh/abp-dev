...
namespace SmartSoftware.AspNetCore.Mvc.UI.Theme.Shared.Tests.SmartSoftware.AspNetCore.Mvc.UI.Theme.Shared.PageToolbars;

public class PageToolbar_Tests : SmartSoftwareAspNetCoreMvcUiThemeSharedTestBase
{
    protected override void ConfigureServices(IServiceCollection services)
    {
        services.Configure<SmartSoftwarePageToolbarOptions>(options =>
        {
    ...
    [Fact]
    public void SmartSoftwarePageToolbarOptions_Should_Contain_Contributors()
    {
        var options = GetRequiredService<IOptions<SmartSoftwarePageToolbarOptions>>().Value;
    ...
    public async Task PageToolbarManager_Should_Return_ToolbarItems()
    {
        ...
        items[0].ComponentType.ShouldBe(typeof(SmartSoftwarePageToolbarButtonViewComponent));
    ...
    public class MyPageComponent1 : SmartSoftwareViewComponent
    {
    ...
    public class MyPageComponent2 : SmartSoftwareViewComponent
    {
        public IViewComponentResult InvokeAsync()
        {
    ...
    public class MyPageComponent3 : SmartSoftwareViewComponent
    {
        public IViewComponentResult InvokeAsync()
        {
    ...
    public class MyPageComponent4 : SmartSoftwareViewComponent
    {
        public IViewComponentResult InvokeAsync()
        {
    ...
    public class MyPageComponent5 : SmartSoftwareViewComponent
    {
        public IViewComponentResult InvokeAsync()
        {
            return Content("MyPageComponent4");
