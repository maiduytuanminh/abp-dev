...
namespace SmartSoftware.Text.Formatting;
...
public class FormattedStringValueExtracter_Tests
{
    ...
    public void Test_Matched()
    {
        ...
        Test_Matched_Internal(
            "smartsoftware.io",
            "{domain}",
            new NameValue("domain", "smartsoftware.io")
        );

        Test_Matched_Internal(
            "http://acme.smartsoftware.io/gaming/Index.html",
            "http://{TENANCY_NAME}.smartsoftware.io/{AREA}/Index.html",
