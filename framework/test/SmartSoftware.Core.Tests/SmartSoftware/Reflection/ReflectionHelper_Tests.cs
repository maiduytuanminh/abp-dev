...
public class ReflectionHelper_Tests
{
    ...
    public void GetValueByPath_Test()
    {
        ...
        ReflectionHelper.GetValueByPath(value, value.GetType(), "SmartSoftware.Reflection.ReflectionHelper_Tests+GetValueByPathTestClass.Name").ShouldBe("test");
        ...
        ReflectionHelper.GetValueByPath(value, value.GetType(), "SmartSoftware.Reflection.ReflectionHelper_Tests+GetValueByPathTestClass.Children.Name").ShouldBe("test-children");
...
{
    public const string GroupName = "SmartSoftwareIdentity";
