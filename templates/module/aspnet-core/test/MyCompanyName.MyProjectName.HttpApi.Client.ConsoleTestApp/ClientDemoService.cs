...
public class ClientDemoService : ITransientDependency
{
    ...
    /* Shows how to perform an HTTP request to the API using SS's dynamic c# proxy
     * feature. It is just simple as calling a local service method.
     * Authorization and HTTP request details are handled by the SS framework.
     */
     ...
     * It uses SS's IIdentityModelAuthenticationService to simplify obtaining access tokens.
     */
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        //Get access token using SS's IIdentityModelAuthenticationService
