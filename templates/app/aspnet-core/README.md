...
This is a layered startup solution based on [Domain Driven Design (DDD)](https://docs.smartsoftware.io/en/ss/latest/Domain-Driven-Design) practises. All the fundamental SS modules are already installed. 
...
* [Web Application Development Tutorial](https://docs.smartsoftware.io/en/ss/latest/Tutorials/Part-1)
* [Application Startup Template Structure](https://docs.smartsoftware.io/en/ss/latest/Startup-Templates/Application)
<TEMPLATE-REMOVE IF-NOT='ui:mvc'>
