...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    public OpenIddictDataSeedContributor(
        ...
        ISmartSoftwareApplicationManager applicationManager,
        ...
        List<string>? permissions = null)
    {
        ...
        var application = new SmartSoftwareApplicationDescriptor {
            ClientId = name,
            ClientType = type,
            ClientSecret = secret,
    ...
    private bool HasSameRedirectUris(OpenIddictApplication existingClient, SmartSoftwareApplicationDescriptor application)
    {
        return existingClient.RedirectUris == JsonSerializer.Serialize(application.RedirectUris.Select(q => q.ToString().TrimEnd('/')));
    }

    private bool HasSameScopes(OpenIddictApplication existingClient, SmartSoftwareApplicationDescriptor application)
    {
