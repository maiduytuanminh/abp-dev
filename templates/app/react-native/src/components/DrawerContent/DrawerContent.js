...
const screens = {
  ...
  UsersStack: {
    label: 'SmartSoftwareIdentity::Users',
    iconName: 'people',
    requiredPolicy: 'SmartSoftwareIdentity.Users',
  },
  TenantsStack: {
    label: 'SmartSoftwareTenantManagement::Tenants',
    iconName: 'book-outline',
    requiredPolicy: 'SmartSoftwareTenantManagement.Tenants',
  },
  SettingsStack: { label: 'SmartSoftwareSettingManagement::Settings', iconName: 'cog' },
};
