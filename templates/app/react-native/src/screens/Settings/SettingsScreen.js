      ...
      <List px="0" py="0" borderWidth="0">
        ...
        <List.Item
          ...
          <View
            ...
            <Text ml="2">{i18n.t('SmartSoftwareUi::ChangePassword')}</Text>
        ...
        <List.Item style={{ backgroundColor: '#fff' }}>
          <FormControl my="2">
            <Stack mx="2">
              <FormControl.Label>{i18n.t('SmartSoftwareUi::Language')}</FormControl.Label>
              <Select
                mode="dropdown"
        ...
        <Button
          ...
          {i18n.t('SmartSoftwareAccount::Logout')}
        </Button>
      </List>
    </View>
  );
