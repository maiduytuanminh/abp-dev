...
const validations = {
  name: Yup.string().required('SmartSoftwareAccount::ThisFieldIsRequired.'),
};
...
function CreateUpdateTenantForm({ editingTenant = {}, submit, remove }) {
  ...
  const hasRemovePermission = usePermission('SmartSoftwareTenantManagement.Tenants.Delete');
  ...
  const adminPasswordValidation = Yup.lazy(() =>
    Yup.string().required('SmartSoftwareAccount::ThisFieldIsRequired.'),
  );
    ...
    <>
      <Box w={{ base: '100%' }} px="3">
        <FormControl isRequired my="2">
          <Stack mx="4">
            <FormControl.Label>{i18n.t('SmartSoftwareTenantManagement::TenantName')}</FormControl.Label>
            <Input
              ref={tenantNameRef}
        ...
        {!editingTenant.id ? (
          <>
            <FormControl isRequired my="2">
              <Stack mx="4">
                <FormControl.Label>
                  {i18n.t('SmartSoftwareTenantManagement::DisplayName:AdminEmailAddress')}
                </FormControl.Label>
                <Input
                  ref={adminEmailRef}
            ...
            <FormControl isRequired my="2">
              <Stack mx="4">
                <FormControl.Label>
                  {i18n.t('SmartSoftwareTenantManagement::DisplayName:AdminPassword')}
                </FormControl.Label>
                <Input
      ...
      <FormButtons
        ...
        remove={remove}
        removeMessage={i18n.t('SmartSoftwareTenantManagement::TenantDeletionConfirmationMessage', {
