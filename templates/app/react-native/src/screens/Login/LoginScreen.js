...
const ValidationSchema = object().shape({
  username: string().required('SmartSoftwareAccount::ThisFieldIsRequired.'),
  password: string().required('SmartSoftwareAccount::ThisFieldIsRequired.'),
});
    ...
    <Center flex={0.6} px="3">
      ...
      >
        <FormControl isRequired my="2">
          <Stack mx="4">
            <FormControl.Label>
              {i18n.t('SmartSoftwareAccount::UserNameOrEmailAddress')}
            </FormControl.Label>
            <Input
        ...
        <FormControl isRequired my="2">
          <Stack mx="4">
            <FormControl.Label>
              {i18n.t('SmartSoftwareAccount::Password')}
            </FormControl.Label>
            <Input
              type="password"
        ...
        <View style={{ marginTop: 20, alignItems: 'center' }}>
          <Button onPress={formik.handleSubmit} width="30%" size="lg">
            {i18n.t('SmartSoftwareAccount::Login')}
          </Button>
        </View>
      </Box>
    </Center>
