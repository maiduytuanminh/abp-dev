...
using SmartSoftware.PermissionManagement.Web.Utils;

namespace SmartSoftware.PermissionManagement.Web.Pages.SmartSoftwarePermissionManagement;

public class PermissionManagementModal : SmartSoftwarePageModel
{
    [Required]
    [HiddenInput]
    ...
    {
        ObjectMapperContext = typeof(SmartSoftwarePermissionManagementWebModule);
