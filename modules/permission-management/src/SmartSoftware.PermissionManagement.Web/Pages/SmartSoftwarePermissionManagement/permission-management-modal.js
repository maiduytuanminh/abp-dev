...
(function ($) {
    ...
    ss.modals.PermissionManagement = function () {
        var l = ss.localization.getResource("SmartSoftwarePermissionManagement");
            ...
            if($submitButton) {
                $submitButton.click(function (e) {
                    ...
                    if(!$form.find("input:checked").length > 0) {
                        ss.message.confirm(l("SaveWithoutAnyPermissionsWarningMessage"))
