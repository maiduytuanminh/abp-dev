...
public class PermissionDefinitionSerializer_Tests : PermissionTestBase
{
    ...
    public async Task Serialize_Complex_Permission_Definition()
    {
        ...
        var permission1 = group1.AddPermission(
                "Permission1",
                new LocalizableString(typeof(SmartSoftwarePermissionManagementResource), "Permission1"),
        ...
        permissionRecord.DisplayName.ShouldBe("L:SmartSoftwarePermissionManagement,Permission1");
