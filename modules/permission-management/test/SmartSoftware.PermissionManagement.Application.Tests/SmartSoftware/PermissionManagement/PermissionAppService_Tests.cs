...
namespace SmartSoftware.PermissionManagement.Application.Tests.SmartSoftware.PermissionManagement;

public class PermissionAppService_Tests : SmartSoftwarePermissionManagementApplicationTestBase
{
    ...
    public async Task GetAsync()
    {
        ...
        using (_currentPrincipalAccessor.Change(new Claim(SmartSoftwareClaimTypes.Role, "super-admin")))
        {
