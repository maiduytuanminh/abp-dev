...
public class ProfileAppService_Tests : SmartSoftwareAccountApplicationTestBase
{
    ...
    public async Task ChangePasswordAsync_FailsForSamePassword()
    {
        ...
        }).ShouldThrowAsync<SmartSoftwareValidationException>();
    ...
    {
        return CreateRandomString() + "@smartsoftware.io";
    }
