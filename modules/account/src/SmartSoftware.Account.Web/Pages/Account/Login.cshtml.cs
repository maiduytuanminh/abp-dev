...
public class LoginModel : AccountPageModel
{
    ...
    protected SmartSoftwareAccountOptions AccountOptions { get; }
    ...
    public LoginModel(
        ...
        IOptions<SmartSoftwareAccountOptions> accountOptions,
    ...
    public virtual async Task<IActionResult> OnGetExternalLoginCallbackAsync(string returnUrl = "", string returnUrlHash = "", string remoteError = null)
    {
        ...
        var email = loginInfo.Principal.FindFirstValue(SmartSoftwareClaimTypes.Email) ?? loginInfo.Principal.FindFirstValue(ClaimTypes.Email);
