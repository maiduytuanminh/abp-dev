...
public class SmartSoftwareOpenIddictAuthorizationCache : SmartSoftwareOpenIddictCacheBase<OpenIddictAuthorization, OpenIddictAuthorizationModel, IOpenIddictAuthorizationStore<OpenIddictAuthorizationModel>>,
    IOpenIddictAuthorizationCache<OpenIddictAuthorizationModel>,
    ITransientDependency
{
    public SmartSoftwareOpenIddictAuthorizationCache(
