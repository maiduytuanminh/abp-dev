...
public class SmartSoftwareOpenIddictAuthorizationStore : SmartSoftwareOpenIddictStoreBase<IOpenIddictAuthorizationRepository>, IOpenIddictAuthorizationStore<OpenIddictAuthorizationModel>
{
    ...
    public SmartSoftwareOpenIddictAuthorizationStore(
        ...
        IOptions<SmartSoftwareOpenIddictStoreOptions> storeOptions)
    ...
    public virtual async ValueTask DeleteAsync(OpenIddictAuthorizationModel authorization, CancellationToken cancellationToken)
    {
        ...
        catch (SmartSoftwareDbConcurrencyException e)
        {
