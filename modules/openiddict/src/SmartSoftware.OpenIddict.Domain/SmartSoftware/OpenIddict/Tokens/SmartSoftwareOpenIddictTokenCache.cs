...
public class SmartSoftwareOpenIddictTokenCache : SmartSoftwareOpenIddictCacheBase<OpenIddictToken, OpenIddictTokenModel, IOpenIddictTokenStore<OpenIddictTokenModel>>,
    IOpenIddictTokenCache<OpenIddictTokenModel>,
    ITransientDependency
{
    public SmartSoftwareOpenIddictTokenCache(
