...
public class SmartSoftwareOpenIddictTokenStore : SmartSoftwareOpenIddictStoreBase<IOpenIddictTokenRepository>, IOpenIddictTokenStore<OpenIddictTokenModel>
{
    ...
    public SmartSoftwareOpenIddictTokenStore(
