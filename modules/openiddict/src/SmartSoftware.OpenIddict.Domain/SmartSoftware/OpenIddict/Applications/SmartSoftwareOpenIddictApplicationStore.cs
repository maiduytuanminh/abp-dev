...
public class SmartSoftwareOpenIddictApplicationStore : SmartSoftwareOpenIddictStoreBase<IOpenIddictApplicationRepository>, ISmartSoftwareOpenIdApplicationStore
{
    protected IOpenIddictTokenRepository TokenRepository { get; }

    public SmartSoftwareOpenIddictApplicationStore(
