...
public class SmartSoftwareOpenIddictScopeStore : SmartSoftwareOpenIddictStoreBase<IOpenIddictScopeRepository>, IOpenIddictScopeStore<OpenIddictScopeModel>
{
    public SmartSoftwareOpenIddictScopeStore(
