...
public class SmartSoftwareOpenIddictScopeCache : SmartSoftwareOpenIddictCacheBase<OpenIddictScope, OpenIddictScopeModel, IOpenIddictScopeStore<OpenIddictScopeModel>>,
    IOpenIddictScopeCache<OpenIddictScopeModel>,
    ITransientDependency
{
    public SmartSoftwareOpenIddictScopeCache(
