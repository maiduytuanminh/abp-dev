...
public abstract class SmartSoftwareOpenIddictWildcardDomainBase<THandler, TOriginalHandler, TContext> : IOpenIddictServerHandler<TContext>
    ...
    where TContext : OpenIddictServerEvents.BaseContext
{
    ...
    protected SmartSoftwareOpenIddictWildcardDomainOptions WildcardDomainOptions { get; }

    protected SmartSoftwareOpenIddictWildcardDomainBase(IOptions<SmartSoftwareOpenIddictWildcardDomainOptions> wildcardDomainOptions, TOriginalHandler originalHandler)
    {
