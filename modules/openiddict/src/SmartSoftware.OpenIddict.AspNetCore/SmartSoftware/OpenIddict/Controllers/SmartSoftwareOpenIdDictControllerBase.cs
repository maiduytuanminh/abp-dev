...
public abstract class SmartSoftwareOpenIdDictControllerBase : SmartSoftwareController
{
    ...
    protected SmartSoftwareOpenIddictClaimsPrincipalManager OpenIddictClaimsPrincipalManager => LazyServiceProvider.LazyGetRequiredService<SmartSoftwareOpenIddictClaimsPrincipalManager>();
    protected ISmartSoftwareClaimsPrincipalFactory SmartSoftwareClaimsPrincipalFactory => LazyServiceProvider.LazyGetRequiredService<ISmartSoftwareClaimsPrincipalFactory>();

    protected SmartSoftwareOpenIdDictControllerBase()
    {
        LocalizationResource = typeof(SmartSoftwareOpenIddictResource);
    }
