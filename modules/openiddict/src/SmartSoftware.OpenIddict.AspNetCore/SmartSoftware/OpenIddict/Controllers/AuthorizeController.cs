...
using SmartSoftware.OpenIddict.ViewModels.Authorization;
...
public class AuthorizeController : SmartSoftwareOpenIdDictControllerBase
{
    [HttpGet, HttpPost]
    [IgnoreAntiforgeryToken]
    [IgnoreSmartSoftwareSecurityHeader]
    public virtual async Task<IActionResult> HandleAsync()
    {
        ...
        var dynamicPrincipal = await SmartSoftwareClaimsPrincipalFactory.CreateDynamicAsync(result.Principal);
