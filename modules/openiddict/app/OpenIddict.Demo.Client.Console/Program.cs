...
const string email = "admin@smartsoftware.io";
const string password = "1q2w3E*";
const string server = "https://localhost:44301/";
const string serverApi = "https://localhost:44301/api/ss/application-configuration";
const string api = "https://localhost:44303/api/claims";
const string clientId = "SmartSoftwareApp";
...
var passwordTokenRequest = new PasswordTokenRequest
{
    ...
    UserName = email,
    Password = password,
    Scope = "SmartSoftwareAPI profile roles email phone offline_access",
};
...
tokenResponse = await client.RequestClientCredentialsTokenAsync(new ClientCredentialsTokenRequest
{
    ...
    Scope = "SmartSoftwareAPI offline_access",
});
