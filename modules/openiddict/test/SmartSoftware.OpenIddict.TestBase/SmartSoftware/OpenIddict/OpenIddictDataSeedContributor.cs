...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    public OpenIddictDataSeedContributor(
        ...
        IClock clock,
        SmartSoftwareOpenIddictTestData testData)
    {
    ...
    {
        await _applicationManager.CreateAsync(await GetOpenIddictApplicationModelAsync(_testData.App1Id, new SmartSoftwareApplicationDescriptor
        {
            ...
            RedirectUris =
            {
                new Uri("https://smartsoftware.io")
            },
            ...
            ClientUri = "https://smartsoftware.io/TestApplication",
            LogoUri = "https://smartsoftware.io/TestApplication.png"
        }));

        await _applicationManager.CreateAsync(await GetOpenIddictApplicationModelAsync(_testData.App2Id, new SmartSoftwareApplicationDescriptor
        {
            ...
            ClientUri = "https://smartsoftware.io/TestApplication2",
            LogoUri = "https://smartsoftware.io/TestApplication2.png"
        }));
    }
