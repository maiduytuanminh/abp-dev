...
public abstract class IdentityUserRepository_Tests<TStartupModule> : SmartSoftwareIdentityTestBase<TStartupModule>
    where TStartupModule : ISmartSoftwareModule
{
    ...
    {
        (await UserRepository.FindByNormalizedEmailAsync(LookupNormalizer.NormalizeEmail("john.nash@smartsoftware.io"))).ShouldNotBeNull();
        (await UserRepository.FindByNormalizedEmailAsync(LookupNormalizer.NormalizeEmail("david@smartsoftware.io"))).ShouldNotBeNull();
        (await UserRepository.FindByNormalizedEmailAsync(LookupNormalizer.NormalizeEmail("undefined-user@smartsoftware.io"))).ShouldBeNull();
    }
