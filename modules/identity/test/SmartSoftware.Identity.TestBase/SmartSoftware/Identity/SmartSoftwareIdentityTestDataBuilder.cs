...
public class SmartSoftwareIdentityTestDataBuilder : ITransientDependency
{
    ...
    public SmartSoftwareIdentityTestDataBuilder(
    ...
    {
        var adminUser = new IdentityUser(_guidGenerator.Create(), "administrator", "admin@smartsoftware.io");
        ...
        var david = new IdentityUser(_testData.UserDavidId, "david", "david@smartsoftware.io");
        david.AddOrganizationUnit(_ou112.Id);
        await _userRepository.InsertAsync(david);

        var neo = new IdentityUser(_testData.UserNeoId, "neo", "neo@smartsoftware.io");
        ...
        var bob = new IdentityUser(_testData.UserBobId, "bob", "bob@smartsoftware.io");
