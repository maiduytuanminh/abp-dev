...
public class Distributed_Role_Change_Events_Test : SmartSoftwareIdentityDomainTestBase
{
    ...
    {
        var x = GetRequiredService<IOptions<SmartSoftwareDistributedEntityEventOptions>>();
