...
public class IdentityOptions_Tests : SmartSoftwareIdentityDomainTestBase
{
    ...
    [Fact]
    public void Should_Resolve_SmartSoftwareIdentityOptionsManager()
    {
        GetRequiredService<IOptions<IdentityOptions>>().ShouldBeOfType(typeof(SmartSoftwareIdentityOptionsManager));
    }
