...
public class IdentityUserStore_Tests : SmartSoftwareIdentityDomainTestBase
{
    ...
    public async Task CreateAsync()
    {
        ...
        var user = new IdentityUser(userId, "bob.lee", "bob.lee@smartsoftware.io");
        ...
        bobLee.Email.ShouldBe("bob.lee@smartsoftware.io");
    }
    ...
    public async Task SetEmailAsync()
    {
        ...
        await _identityUserStore.SetEmailAsync(user, "john.nash.kobe@smartsoftware.io");

        user.Email.ShouldBe("john.nash.kobe@smartsoftware.io");
        //user.NormalizedEmail.ShouldBe(_lookupNormalizer.Normalize("john.nash.kobe@smartsoftware.io"));
    }
    ...
    public async Task SetNormalizedEmailAsync()
    {
        ...
        await _identityUserStore.SetNormalizedEmailAsync(user, _lookupNormalizer.NormalizeEmail("john.nash.kobe@smartsoftware.io"));

        user.NormalizedEmail.ShouldBe(_lookupNormalizer.NormalizeEmail("john.nash.kobe@smartsoftware.io"));
    }

    [Fact]
    public async Task FindByEmailAsync()
    {
        var user = await _identityUserStore.FindByEmailAsync(_lookupNormalizer.NormalizeEmail("john.nash@smartsoftware.io"));

        user.ShouldNotBeNull();
        user.Email.ShouldBe("john.nash@smartsoftware.io");
    }
