...
public static class IdentityDbContextModelBuilderExtensions
{
    public static void ConfigureIdentity([NotNull] this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "Users", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "UserClaims", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "UserRoles", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "UserLogins", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "UserTokens", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "Roles", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "RoleClaims", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "ClaimTypes", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "OrganizationUnits", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "OrganizationUnitRoles", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "UserOrganizationUnits", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "SecurityLogs", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "LinkUsers", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "UserDelegations", SmartSoftwareIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareIdentityDbProperties.DbTablePrefix + "Sessions", SmartSoftwareIdentityDbProperties.DbSchema);
