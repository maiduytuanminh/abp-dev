...
public class IdentityClaimTypeManager : DomainService
{
    ...
    public virtual async Task<IdentityClaimType> UpdateAsync(IdentityClaimType claimType)
    {
        ...
        {
            throw new SmartSoftwareException($"Name Exist: {claimType.Name}");
        }

        if (claimType.IsStatic)
        {
            throw new SmartSoftwareException($"Can not update a static ClaimType.");
        }
    ...
    public virtual async Task DeleteAsync(Guid id)
    {
        ...
        if (claimType.IsStatic)
        {
            throw new SmartSoftwareException($"Can not delete a static ClaimType.");
        }
