...
public static class SmartSoftwareIdentityResultExtensions
{
    private static readonly Dictionary<string, string> IdentityStrings = new Dictionary<string, string>();

    static SmartSoftwareIdentityResultExtensions()
    {
        ...
        if (resourceSet == null)
        {
            throw new SmartSoftwareException("Can't get the ResourceSet of Identity.");
        }
        ...
        {
            throw new SmartSoftwareException("ResourceSet values of Identity is empty.");
        }
    }
    ...
    public static void CheckErrors(this IdentityResult identityResult)
    {
        ...
        throw new SmartSoftwareIdentityResultException(identityResult);
    }
    ...
    {
        var key = $"SmartSoftware.Identity:{error.Code}";
        ...
        return localizer["SmartSoftware.Identity:DefaultError"];
    }
