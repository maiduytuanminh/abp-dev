...
public class SmartSoftwareSecurityStampValidatorCallback
{
    /// <summary>
    ...
    public class SecurityStampValidatorCallback
    {
        ...
        /// <param name="refreshingPrincipalOptions">The SmartSoftwareRefreshingPrincipalOptions.</param>
        /// <returns></returns>
        public static Task UpdatePrincipal(SecurityStampRefreshingPrincipalContext context, SmartSoftwareRefreshingPrincipalOptions refreshingPrincipalOptions)
        {
