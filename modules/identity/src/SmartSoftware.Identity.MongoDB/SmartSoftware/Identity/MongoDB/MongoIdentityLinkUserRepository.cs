...
public class MongoIdentityLinkUserRepository : MongoDbRepository<ISmartSoftwareIdentityMongoDbContext, IdentityLinkUser, Guid>, IIdentityLinkUserRepository
{
    public MongoIdentityLinkUserRepository(IMongoDbContextProvider<ISmartSoftwareIdentityMongoDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
