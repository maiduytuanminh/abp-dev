...
public class MongoIdentityClaimTypeRepository : MongoDbRepository<ISmartSoftwareIdentityMongoDbContext, IdentityClaimType, Guid>, IIdentityClaimTypeRepository
{
    public MongoIdentityClaimTypeRepository(IMongoDbContextProvider<ISmartSoftwareIdentityMongoDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
