...
public class MongoIdentityUserRepository : MongoDbRepository<ISmartSoftwareIdentityMongoDbContext, IdentityUser, Guid>, IIdentityUserRepository
{
    public MongoIdentityUserRepository(IMongoDbContextProvider<ISmartSoftwareIdentityMongoDbContext> dbContextProvider)
