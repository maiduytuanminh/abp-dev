...
public class MongoIdentityRoleRepository : MongoDbRepository<ISmartSoftwareIdentityMongoDbContext, IdentityRole, Guid>, IIdentityRoleRepository
{
    public MongoIdentityRoleRepository(IMongoDbContextProvider<ISmartSoftwareIdentityMongoDbContext> dbContextProvider)
