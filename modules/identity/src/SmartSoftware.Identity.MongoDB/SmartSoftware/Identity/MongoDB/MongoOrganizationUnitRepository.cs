...
public class MongoOrganizationUnitRepository
    : MongoDbRepository<ISmartSoftwareIdentityMongoDbContext, OrganizationUnit, Guid>,
    IOrganizationUnitRepository
{
    public MongoOrganizationUnitRepository(
        IMongoDbContextProvider<ISmartSoftwareIdentityMongoDbContext> dbContextProvider)
