...
using SmartSoftware.PermissionManagement.Blazor.Components;
using SmartSoftware.Users;

namespace SmartSoftware.Identity.Blazor.Pages.Identity;
...
public partial class UserManagement
{
    ...
    {
        ObjectMapperContext = typeof(SmartSoftwareIdentityBlazorModule);
