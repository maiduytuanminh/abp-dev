...
namespace SmartSoftwareDocs.Migrator
{
    class Program
    {
        ...
        {
            Console.WriteLine("Initializing SmartSoftwareDocs Migrator ... ");

            using (var app = SmartSoftwareApplicationFactory.Create<SmartSoftwareDocsMigratorModule>())
            {
                app.Initialize();

                using (var dbContext = app.Resolve<SmartSoftwareDocsDbContext>())
                {
        ...
        private static void RunMigrations(string connectionString, SmartSoftwareDocsDbContext dbContext)
        {
        ...
        private static void GenerateMigrationScript(SmartSoftwareDocsDbContext dbContext)
        {
