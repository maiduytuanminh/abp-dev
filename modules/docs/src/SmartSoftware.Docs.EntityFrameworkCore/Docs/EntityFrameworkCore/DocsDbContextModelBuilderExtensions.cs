...
namespace SmartSoftware.Docs.EntityFrameworkCore
{
    public static class DocsDbContextModelBuilderExtensions
    {
            ...
            [NotNull] this ModelBuilder builder)
        {
            ...
            {
                b.ToTable(SmartSoftwareDocsDbProperties.DbTablePrefix + "Projects", SmartSoftwareDocsDbProperties.DbSchema);
            ...
            {
                b.ToTable(SmartSoftwareDocsDbProperties.DbTablePrefix + "Documents", SmartSoftwareDocsDbProperties.DbSchema);
            ...
            {
                b.ToTable(SmartSoftwareDocsDbProperties.DbTablePrefix + "DocumentContributors", SmartSoftwareDocsDbProperties.DbSchema);
