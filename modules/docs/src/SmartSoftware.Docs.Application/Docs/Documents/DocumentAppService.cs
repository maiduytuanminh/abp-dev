...
namespace SmartSoftware.Docs.Documents
{
    public class DocumentAppService : DocsAppServiceBase, IDocumentAppService
    {
        ...
        {
            var value = _configuration["SmartSoftware.Docs:DocumentCacheTimeoutInterval"];
        ...
        {
            var value = _configuration["SmartSoftware.Docs:DocumentResource.AbsoluteExpirationRelativeToNow"];
            if (value.IsNullOrEmpty())
            {
                return TimeSpan.FromHours(6);
            }
        ...
        {
            var value = _configuration["SmartSoftware.Docs:DocumentResource.SlidingExpiration"];
            if (value.IsNullOrEmpty())
            {
