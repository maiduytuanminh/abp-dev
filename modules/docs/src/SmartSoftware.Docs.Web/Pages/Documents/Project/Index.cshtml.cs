...
namespace SmartSoftware.Docs.Pages.Documents.Project
{
    public class IndexModel : SmartSoftwarePageModel
    {
        ...
        private IActionResult ReloadPageWithCulture()
        {
            ...
            return Redirect(sb.Append("/SmartSoftware/Languages/Switch?culture=").Append(LanguageCode).Append("&uiCulture=")
        ...
        private void SetUserPreferences()
        {
            ...
            var cookie = Request.Cookies["SmartSoftwareDocsPreferences"];
