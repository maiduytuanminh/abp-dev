$(function () {
    ...
    var service = window.smartsoftware.docs.admin.documentsAdmin;
    ...
    var parseDateToLocaleDateString = function (date) {
        ...
        return new Date(parsedDate).toLocaleDateString(
            ss.localization.currentCulture.name
        );
    };
    ...
    var dataTable = $('#DocumentsTable').DataTable(
        ss.libs.datatables.normalizeConfiguration({
            ...
            autoWidth: false,
            scrollCollapse: true,
            ajax: ss.libs.datatables.createAjax(service.getAll, getFilter),
            columnDefs: [
                {
                    rowAction: {
                        items: [
                            {
                                ...
                                action: function (data) {
                                    service
                                        ...
                                        .then(function () {
                                            ss.notify.success(l('RemovedFromCache'));
                            ...
                            },
                            {
                                ...
                                action: function (data) {
                                    service
                                        ...
                                        .then(function () {
                                            ss.message.success(l('ReindexCompleted'));
                                            dataTable.ajax.reloadEx();
                                        });
                                },
                            }
