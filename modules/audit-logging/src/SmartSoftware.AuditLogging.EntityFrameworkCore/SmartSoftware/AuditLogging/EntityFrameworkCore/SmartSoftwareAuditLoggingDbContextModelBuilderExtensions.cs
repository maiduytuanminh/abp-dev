...
public static class SmartSoftwareAuditLoggingDbContextModelBuilderExtensions
{
        ...
        [NotNull] this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(SmartSoftwareAuditLoggingDbProperties.DbTablePrefix + "AuditLogs", SmartSoftwareAuditLoggingDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareAuditLoggingDbProperties.DbTablePrefix + "AuditLogActions", SmartSoftwareAuditLoggingDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareAuditLoggingDbProperties.DbTablePrefix + "EntityChanges", SmartSoftwareAuditLoggingDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareAuditLoggingDbProperties.DbTablePrefix + "EntityPropertyChanges", SmartSoftwareAuditLoggingDbProperties.DbSchema);
        ...
        builder.TryConfigureObjectExtensions<SmartSoftwareAuditLoggingDbContext>();
    }
}
