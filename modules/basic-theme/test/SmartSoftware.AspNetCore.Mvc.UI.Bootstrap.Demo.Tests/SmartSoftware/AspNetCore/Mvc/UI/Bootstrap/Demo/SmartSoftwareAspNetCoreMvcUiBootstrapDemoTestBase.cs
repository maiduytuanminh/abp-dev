...
public abstract class SmartSoftwareAspNetCoreMvcUiBootstrapDemoTestBase : SmartSoftwareAspNetCoreIntegratedTestBase<TestStartup>
{
    ...
    private static string CalculateContentRootPath()
    {
        return CalculateContentRootPath(
            "SmartSoftware.sln",
            $"test{Path.DirectorySeparatorChar}SmartSoftware.AspNetCore.Mvc.UI.Bootstrap.Demo"
        );
    }
