...
public class DatePickerModel : PageModel
{
    ...
    public SmartSoftwareDatePickerOptions DatePickerOptions { get; set; }
    ...
    public void OnGet()
    {
        ...
        DatePickerOptions = new SmartSoftwareDatePickerOptions();
        DatePickerOptions.LinkedCalendars = false;
        DatePickerOptions.Ranges = new List<SmartSoftwareDatePickerRange>();
        DatePickerOptions.Ranges.Add(new SmartSoftwareDatePickerRange("Today", DateTime.Now, DateTime.Now));
    }
