...
using SmartSoftware.AspNetCore.Mvc.UI.Bootstrap.Demo.Pages.Menus;
using SmartSoftware.UI.Navigation;

namespace SmartSoftware.AspNetCore.Mvc.UI.Theme.Basic.Demo.Menus;
    ...
    private void AddMainMenuItems(MenuConfigurationContext context)
    {
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                ...
                url: "https://community.smartsoftware.io"
            )
        );
        context.Menu.AddItem(
            new ApplicationMenuItem(
                ...
                url: "https://commercial.smartsoftware.io"
            )
        );
        context.Menu.AddItem(
            new ApplicationMenuItem(
                ...
                url: "https://Docs.smartsoftware.io"
            )
        );
        context.Menu.AddItem(
            new ApplicationMenuItem(
                name: "Github",
                displayName: "Github",
                url: "https://github.com/ssframework/ss",
                icon:"fa fa-github"
            )
        );
    }
