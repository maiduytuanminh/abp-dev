...
public class LanguageSwitchViewComponent : SmartSoftwareViewComponent
{
    ...
    public virtual async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        {
            var ssRequestLocalizationOptionsProvider = HttpContext.RequestServices.GetRequiredService<ISmartSoftwareRequestLocalizationOptionsProvider>();
            var localizationOptions = await ssRequestLocalizationOptionsProvider.GetLocalizationOptionsAsync();
