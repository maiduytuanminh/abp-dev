...
public static class SettingManagementDbContextModelBuilderExtensions
{
        ...
        [NotNull] this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(SmartSoftwareSettingManagementDbProperties.DbTablePrefix + "Settings", SmartSoftwareSettingManagementDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareSettingManagementDbProperties.DbTablePrefix + "SettingDefinitions", SmartSoftwareSettingManagementDbProperties.DbSchema);
