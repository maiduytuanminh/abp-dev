...
public class TenantStore : ITenantStore, ITransientDependency
{
    ...
    protected IObjectMapper<SmartSoftwareTenantManagementDomainModule> ObjectMapper { get; }
    protected ICurrentTenant CurrentTenant { get; }
    protected IDistributedCache<TenantConfigurationCacheItem> Cache { get; }

    public TenantStore(
        ITenantRepository tenantRepository,
        IObjectMapper<SmartSoftwareTenantManagementDomainModule> objectMapper,
    ...
    protected virtual async Task<TenantConfigurationCacheItem> GetCacheItemAsync(Guid? id, string normalizedName)
    {
        ...
        throw new SmartSoftwareException("Both id and normalizedName can't be invalid.");
    }
