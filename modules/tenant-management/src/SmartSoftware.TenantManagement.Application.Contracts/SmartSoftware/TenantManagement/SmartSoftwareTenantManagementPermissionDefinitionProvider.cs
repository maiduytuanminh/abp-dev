...
public class SmartSoftwareTenantManagementPermissionDefinitionProvider : PermissionDefinitionProvider
{
    ...
    {
        return LocalizableString.Create<SmartSoftwareTenantManagementResource>(name);
    }
}
