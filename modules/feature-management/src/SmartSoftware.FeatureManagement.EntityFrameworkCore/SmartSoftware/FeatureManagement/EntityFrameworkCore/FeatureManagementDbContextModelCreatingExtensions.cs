...
public static class FeatureManagementDbContextModelCreatingExtensions
{
        ...
        this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(SmartSoftwareFeatureManagementDbProperties.DbTablePrefix + "FeatureValues", SmartSoftwareFeatureManagementDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareFeatureManagementDbProperties.DbTablePrefix + "FeatureGroups", SmartSoftwareFeatureManagementDbProperties.DbSchema);
        ...
        {
            b.ToTable(SmartSoftwareFeatureManagementDbProperties.DbTablePrefix + "Features", SmartSoftwareFeatureManagementDbProperties.DbSchema);
