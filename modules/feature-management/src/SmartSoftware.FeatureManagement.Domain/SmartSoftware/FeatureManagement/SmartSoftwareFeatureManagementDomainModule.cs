...
public class SmartSoftwareFeatureManagementDomainModule : SmartSoftwareModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        Configure<FeatureManagementOptions>(options =>
        {
            ...
            options.ProviderPolicies[TenantFeatureValueProvider.ProviderName] = "SmartSoftwareTenantManagement.Tenants.ManageFeatures";
        });

        Configure<SmartSoftwareExceptionLocalizationOptions>(options =>
        {
            options.MapCodeNamespace("SmartSoftwareFeatureManagement", typeof(SmartSoftwareFeatureManagementResource));
        });
            ...
            .ExecuteAsync(async _ =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    scope.ServiceProvider
                        .GetService<ILogger<SmartSoftwareFeatureManagementDomainModule>>()?
                        .LogException(ex);
