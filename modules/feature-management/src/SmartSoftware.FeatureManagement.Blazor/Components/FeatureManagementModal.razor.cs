...
namespace SmartSoftware.FeatureManagement.Blazor.Components;
...
public partial class FeatureManagementModal
{
    ...
    [Inject] protected IOptions<SmartSoftwareLocalizationOptions> LocalizationOptions { get; set; }
    ...
    protected virtual async Task OnFeatureValueChangedAsync(string value, FeatureDto feature)
    {
        ...
        {
            await UiMessageService.Warn(L["SmartSoftware.FeatureManagement:InvalidFeatureValue", feature.DisplayName]);
        }
    }
