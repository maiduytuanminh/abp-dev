...
public class FeatureDefinitionSerializer_Tests : FeatureManagementDomainTestBase
{
    ...
    public async Task Serialize_Complex_Feature_Definition()
    {
        ...
        var feature1 = group1.AddFeature(
                "Feature1",
                "default",
                new LocalizableString(typeof(SmartSoftwareFeatureManagementResource), "Feature1"),
                new LocalizableString(typeof(SmartSoftwareFeatureManagementResource), "Feature1"),
        ...
        featureRecord.DisplayName.ShouldBe("L:SmartSoftwareFeatureManagement,Feature1");
