...
using Client = SmartSoftware.IdentityServer.Clients.Client;
using ClientClaim = SmartSoftware.IdentityServer.Clients.ClientClaim;
using IdentityResource = SmartSoftware.IdentityServer.IdentityResources.IdentityResource;
using PersistedGrant = SmartSoftware.IdentityServer.Grants.PersistedGrant;

namespace SmartSoftware.IdentityServer;

public class SmartSoftwareIdentityServerTestDataBuilder : ITransientDependency
{
    ...
    public SmartSoftwareIdentityServerTestDataBuilder(
        ...
        SmartSoftwareIdentityServerTestData testData,
    ...
    private async Task AddClients()
    {
        ...
        client.AddCorsOrigin("https://{0}.smartsoftware.io");
