...
public class SmartSoftwareClientConfigurationValidator : DefaultClientConfigurationValidator
{
    public SmartSoftwareClientConfigurationValidator(IdentityServerOptions options)
        : base(options)
    {
    }
