...
using ApiResource = SmartSoftware.IdentityServer.ApiResources.ApiResource;
using ApiScope = SmartSoftware.IdentityServer.ApiScopes.ApiScope;
using IdentityResource = SmartSoftware.IdentityServer.IdentityResources.IdentityResource;
...
public class ResourceStore : IResourceStore
{
    ...
    protected IObjectMapper<SmartSoftwareIdentityServerDomainModule> ObjectMapper { get; }
    ...
    public ResourceStore(
        ...
        IObjectMapper<SmartSoftwareIdentityServerDomainModule> objectMapper,
    ...
    public virtual async Task<IdentityServer4.Models.Resources> GetAllResourcesAsync()
    {
        return await ResourcesCache.GetOrAddAsync(AllResourcesKey, async () =>
        {
            ...
            return new Resources(
                ObjectMapper.Map<List<SmartSoftware.IdentityServer.IdentityResources.IdentityResource>, List<IdentityServer4.Models.IdentityResource>>(identityResources),
                ObjectMapper.Map<List<SmartSoftware.IdentityServer.ApiResources.ApiResource>, List<IdentityServer4.Models.ApiResource>>(apiResources),
                ObjectMapper.Map<List<SmartSoftware.IdentityServer.ApiScopes.ApiScope>, List<IdentityServer4.Models.ApiScope>>(apiScopes));
