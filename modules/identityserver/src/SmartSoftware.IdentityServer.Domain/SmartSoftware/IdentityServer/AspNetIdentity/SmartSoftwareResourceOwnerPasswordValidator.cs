...
public class SmartSoftwareResourceOwnerPasswordValidator : IResourceOwnerPasswordValidator
{
    protected SignInManager<IdentityUser> SignInManager { get; }
    protected IdentityUserManager UserManager { get; }
    protected IdentitySecurityLogManager IdentitySecurityLogManager { get; }
    protected ILogger<ResourceOwnerPasswordValidator<IdentityUser>> Logger { get; }
    protected IStringLocalizer<SmartSoftwareIdentityServerResource> Localizer { get; }
    protected IServiceScopeFactory ServiceScopeFactory { get; }
    protected SmartSoftwareIdentityOptions SmartSoftwareIdentityOptions { get; }
    protected IOptions<IdentityOptions> IdentityOptions { get; }

    protected ISettingProvider SettingProvider { get; }

    public SmartSoftwareResourceOwnerPasswordValidator(
        IdentityUserManager userManager,
        SignInManager<IdentityUser> signInManager,
        IdentitySecurityLogManager identitySecurityLogManager,
        ILogger<ResourceOwnerPasswordValidator<IdentityUser>> logger,
        IStringLocalizer<SmartSoftwareIdentityServerResource> localizer,
        IOptions<SmartSoftwareIdentityOptions> ssIdentityOptions,
        ...
        ISettingProvider settingProvider)
    {
        ...
        SmartSoftwareIdentityOptions = ssIdentityOptions.Value;
    ...
    public virtual async Task ValidateAsync(ResourceOwnerPasswordValidationContext context)
    {
        using (var scope = ServiceScopeFactory.CreateScope())
        {
            ...
            if (SmartSoftwareIdentityOptions.ExternalLoginProviders.Any())
            {
                foreach (var externalLoginProviderInfo in SmartSoftwareIdentityOptions.ExternalLoginProviders.Values)
                {
