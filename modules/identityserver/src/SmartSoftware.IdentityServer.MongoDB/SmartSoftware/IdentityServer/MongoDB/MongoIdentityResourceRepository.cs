...
public class MongoIdentityResourceRepository : MongoDbRepository<ISmartSoftwareIdentityServerMongoDbContext, IdentityResource, Guid>, IIdentityResourceRepository
{
    public MongoIdentityResourceRepository(IMongoDbContextProvider<ISmartSoftwareIdentityServerMongoDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
