...
public class MongoClientRepository : MongoDbRepository<ISmartSoftwareIdentityServerMongoDbContext, Client, Guid>, IClientRepository
{
    public MongoClientRepository(
        IMongoDbContextProvider<ISmartSoftwareIdentityServerMongoDbContext> dbContextProvider
        ) : base(
            dbContextProvider)
    {
    }
