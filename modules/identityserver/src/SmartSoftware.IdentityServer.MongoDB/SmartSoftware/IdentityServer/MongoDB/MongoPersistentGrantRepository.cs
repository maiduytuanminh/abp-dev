...
public class MongoPersistentGrantRepository : MongoDbRepository<ISmartSoftwareIdentityServerMongoDbContext, PersistedGrant, Guid>, IPersistentGrantRepository
{
    public MongoPersistentGrantRepository(IMongoDbContextProvider<ISmartSoftwareIdentityServerMongoDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
