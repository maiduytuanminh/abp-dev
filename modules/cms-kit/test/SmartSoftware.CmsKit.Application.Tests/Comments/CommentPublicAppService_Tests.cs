...
public class CommentPublicAppService_Tests : CmsKitApplicationTestBase
{
    ...
    [Theory]
    [InlineData("https://smartsoftware.io/features")]
    ...
    [Theory]
    [InlineData("[SS Community](https://community.smartsoftware.io/)")]
    [InlineData("<a href='https://docs.smartsoftware.io/en/ss/latest'>docs.smartsoftware.io</a>")]
    ...
    public async Task UpdateAsync_ShouldThrowUserFriendlyException_If_Url_UnAllowed()
    {
        ...
        await Should.ThrowAsync<UserFriendlyException>(async () =>
            await _commentAppService.UpdateAsync(
                ...
                {
                    Text = "[SS Community - Update](https://community.smartsoftware.io/)", //not allowed URL
                }
            ));
    }
