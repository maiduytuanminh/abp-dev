...
public class MediaDescriptorAdminAppService_Tests : CmsKitApplicationTestBase
{
    ...
    public async Task Should_Create_Media()
    {
        ...
        var mediaContent =
            "# SS Framework\nSS Framework is a complete **infrastructure** based on the **ASP.NET Core** to create **modern web applications** and **APIs** by following the software development **best practices** and the **latest technologies**.";
