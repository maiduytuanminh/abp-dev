...
using SmartSoftware.CmsKit.Web.Renderers;

namespace SmartSoftware.CmsKit.Public.Web.Pages.CmsKit.Shared.Components.Commenting;
...
public class CommentingViewComponent : SmartSoftwareViewComponent
{
    ...
    public CommentingViewComponent(
        ...
        IOptions<SmartSoftwareMvcUiOptions> options,
        ...
        IEnumerable<string> referralLinks = null)
    {
        ...
        var loginUrl = $"{SmartSoftwareMvcUiOptions.LoginUrl}?returnUrl={HttpContext.Request.Path.ToString()}&returnUrlHash=#cms-comment_{entityType}_{entityId}";
