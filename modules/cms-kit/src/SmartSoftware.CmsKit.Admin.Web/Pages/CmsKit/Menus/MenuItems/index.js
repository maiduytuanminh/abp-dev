...
$(function () {
    ...
    var menuService = smartsoftware.cmsKit.admin.menus.menuItemAdmin;

    var createModal = new ss.ModalManager({ viewUrl: ss.appPath + 'CmsKit/Menus/MenuItems/CreateModal', modalClass: 'createMenuItem' });
    var updateModal = new ss.ModalManager({ viewUrl: ss.appPath + 'CmsKit/Menus/MenuItems/UpdateModal', modalClass: 'updateMenuItem'});
        ...
        contextMenu: function (node) {
            var items = {
                edit: {
                    label: l('Edit'),
                    icon: 'fa fa-pencil',
                    _disabled: !ss.auth.isGranted('CmsKit.Menus.Update'),
