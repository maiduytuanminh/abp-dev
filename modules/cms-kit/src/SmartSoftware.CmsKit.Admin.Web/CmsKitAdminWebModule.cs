...
public class CmsKitAdminWebModule : SmartSoftwareModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<CmsKitAdminWebModule>("SmartSoftware.CmsKit.Admin.Web");
        });

        context.Services.AddAutoMapperObjectMapper<CmsKitAdminWebModule>();
        Configure<SmartSoftwareAutoMapperOptions>(options => { options.AddMaps<CmsKitAdminWebModule>(validate: true); });
        ...
        OneTimeRunner.Run(() =>
        {
            ModuleExtensionConfigurationHelper
                .ApplyEntityConfigurationToUi(
                    ...
                    createFormTypes: new[] { typeof(SmartSoftware.CmsKit.Admin.Web.Pages.CmsKit.Blogs.CreateModalModel.CreateBlogViewModel) },
                    editFormTypes: new[] { typeof(SmartSoftware.CmsKit.Admin.Web.Pages.CmsKit.Blogs.UpdateModalModel.UpdateBlogViewModel) }
                );
            ...
            ModuleExtensionConfigurationHelper
                .ApplyEntityConfigurationToUi(
                    ...
                    createFormTypes: new[] { typeof(SmartSoftware.CmsKit.Admin.Web.Pages.CmsKit.BlogPosts.CreateModel.CreateBlogPostViewModel) },
                    editFormTypes: new[] { typeof(SmartSoftware.CmsKit.Admin.Web.Pages.CmsKit.BlogPosts.UpdateModel.UpdateBlogPostViewModel) }
                );
            ...
            ModuleExtensionConfigurationHelper
                .ApplyEntityConfigurationToUi(
                    ...
                    createFormTypes: new[] { typeof(SmartSoftware.CmsKit.Admin.Web.Pages.CmsKit.Menus.MenuItems.CreateModalModel.MenuItemCreateViewModel) },
                    editFormTypes: new[] { typeof(SmartSoftware.CmsKit.Admin.Web.Pages.CmsKit.Menus.MenuItems.UpdateModalModel.MenuItemUpdateViewModel) }
                );
            ...
            ModuleExtensionConfigurationHelper
                .ApplyEntityConfigurationToUi(
                    ...
                    createFormTypes: new[] { typeof(SmartSoftware.CmsKit.Admin.Web.Pages.CmsKit.Pages.CreateModel.CreatePageViewModel) },
                    editFormTypes: new[] { typeof(SmartSoftware.CmsKit.Admin.Web.Pages.CmsKit.Pages.UpdateModel.UpdatePageViewModel) }
                );
            ...
            ModuleExtensionConfigurationHelper
                .ApplyEntityConfigurationToUi(
                    ...
                    createFormTypes: new[] { typeof(SmartSoftware.CmsKit.Admin.Web.Pages.CmsKit.Tags.CreateModalModel.TagCreateViewModel) },
                    editFormTypes: new[] { typeof(SmartSoftware.CmsKit.Admin.Web.Pages.CmsKit.Tags.EditModalModel.TagEditViewModel) }
                );
